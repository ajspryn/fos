                ...
                <section class="app-user-view-account">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center flex-column">
                                            <a href="javascript:;" data-bs-target="#editPhoto" data-bs-toggle="modal">
                                                <img class="img-fluid rounded mt-3 mb-2"
                                                    src="{{ Auth::user()->foto ? asset('storage/' . Auth::user()->foto) : asset('app-assets/images/avatars/1.png') }}" height="110"
                                    ...
                                    @if ($role->jabatan_id == 1 && $role->divisi_id != 5)
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                            ...
                            @if ($role->jabatan_id == 1 && $role->divisi_id == 6)
                                <!-- Project table -->
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable-project">
                                            ...
                                            <tbody>
                                                @foreach ($dataNasabahP3ks as $dataNasabahP3k)
                                                    @php
                                                        $proyekPerumahan = Modules\Form\Entities\FormPprPembiayaan::select()
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center">{{ $loop->iteration }}</td>
                                                        <td>{{ $dataNasabahP3k->nama_unit_kerja }}
                                                        </td>
                                                        <td style="text-align: center">{{ $dataNasabahP3k->noa }}</td>
                                                        <td style="text-align: center"></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
