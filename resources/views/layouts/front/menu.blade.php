            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item {{ Request::is('/', 'dashboard') ? 'active' : '' }}"><a
                    class="nav-link d-flex align-items-center" href="/"><i data-feather="home"></i><span
                      class="menu-title text-truncate" data-i18n="Home">Beranda</span></a>
                </li>
                @if (Auth::user())
                  <li class="nav-item {{ Request::is('simulasi') ? 'active' : '' }}"><a
                      class="nav-link d-flex align-items-center" href="/simulasi"><i
                        data-feather="monitor"></i><span class="menu-title text-truncate"
                        data-i18n="home">Simulasi</span></a>
                    </li>
                @endif
