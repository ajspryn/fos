...
<?php if($enableCustomizer): ?>
<script src="<?php echo e(asset('assets/vendor/js/template-customizer.js')); ?>"></script>
<?php endif; ?>
<script src="<?php echo e($isFront ? asset('assets/js/front-config.js') : asset('assets/js/config.js')); ?>"></script>

<?php echo $__env->yieldPushContent('page-css'); ?>
<?php /**PATH /Users/ajspryn/Project/fos/resources/views/layouts/vuexy/head-assets.blade.php ENDPATH**/ ?>