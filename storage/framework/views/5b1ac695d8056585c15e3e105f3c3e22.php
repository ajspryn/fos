    ...
    <script>
        (function () {
            ...
            new Chart(ctx, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($labelnoas); ?>,
                    datasets: [{
                        label: 'NOA Per Bulan',
                        data: <?php echo json_encode($datanoas); ?>,
...
<?php echo $__env->make('umkm::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Umkm/Resources/views/index.blade.php ENDPATH**/ ?>