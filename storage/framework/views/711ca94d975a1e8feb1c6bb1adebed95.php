                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="midCenter">
                                                <?php echo e($proposal->tanggal_pengajuan ? strtoupper(strftime('%d %B %Y', strtotime($proposal->tanggal_pengajuan))) : '-'); ?>

                                            </td>
                                            <td class="midCenter"><?php echo e(optional($proposal->nasabah)->no_ktp); ?></td>
                                            <td class="midCenter"><?php echo e(optional($proposal->nasabah)->nama_nasabah); ?></td>
                                            <td class="midCenter"><?php echo e(optional($proposal->nasabah)->nama_pekerjaan); ?></td>
                                            <td class="midCenter">Rp<?php echo e(number_format($proposal->nominal_pembiayaan, 0, ',', '.')); ?></td>
                                            <td class="midCenter"><?php echo e($proposal->tenor ? $proposal->tenor . ' Bulan' : '-'); ?></td>
                                            <td style="text-align: center">
                                                <a href="/kabag/ultra_mikro/proposal/<?php echo e($proposal->id); ?>" class="btn btn-outline-info btn-sm round">Detail</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/ultra_mikro/proposal/index.blade.php ENDPATH**/ ?>