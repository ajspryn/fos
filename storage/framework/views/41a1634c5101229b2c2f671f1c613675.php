                                    ...
                                    <div class="card-body" style="background:linear-gradient(118deg,#ea5455,rgba(234,84,85,.7));border-radius:inherit;">
                                        ...
                                        <div class="bg-white rounded p-1 mb-1">
                                            ...
                                            <h5 class="mb-0 text-danger fw-bolder">
                                                ...
                                                <small class="text-body fw-normal font-small-3"> / <?php echo e(number_format($targetNominal)); ?></small>
                                            </h5>
                                        </div>
                            ...
                            <div class="card card-statistics h-100 mb-0">
                                ...
                                <div class="card-body statistics-body">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div>
                                            <h4 class="fw-bolder mb-0"><?php echo e($pipeline); ?></h4>
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    ...
                                                    <h4 class="fw-bolder mb-0 mt-25"><?php echo e($batalAkad); ?></h4>
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: <?php echo json_encode($hitungPerBulan); ?>,
    ...
    <script>
        (function () {
            ...
            new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($labelPlafond); ?>,
                    datasets: [{
                        label: 'Plafond Per Bulan',
                        data: <?php echo json_encode($dataPlafond); ?>,
    ...
    <script>
        (function () {
            ...
            new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: <?php echo json_encode($labelJenisNasabah); ?>,
                    datasets: [{
                        data: <?php echo json_encode($dataJenisNasabah); ?>,
    ...
    <script>
        (function () {
            ...
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode($labelNoaProyekPerumahan); ?>,
                    datasets: [{
                        data: <?php echo json_encode($dataNoaProyekPerumahan); ?>,
                        backgroundColor: ['#7367f0', '#28c76f', '#00cfe8', '#ea5455', '#ff9f43'],
                        hoverBackgroundColor: ['#6254e8', '#24b263', '#00b8d4', '#e73d3e', '#ff8f20'],
                    }]
                },
...
<?php echo $__env->make('ppr::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Ppr/Resources/views/index.blade.php ENDPATH**/ ?>