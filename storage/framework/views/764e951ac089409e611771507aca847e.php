                            ...
                            <div class="card h-100 mb-0">
                                <div class="card-body d-flex flex-column justify-content-center" style="background:linear-gradient(118deg,#7367f0,rgba(115,103,240,.7));border-radius:inherit;">
                                    ...
                                    <div class="bg-white rounded p-1">
                                        ...
                                        <h2 class="mb-0 text-primary fw-bolder"><?php echo e($proposalskpd + $a + $data + $proposalppr); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-6">
                            <div class="card text-center mb-0">
                                <div class="card-body">
                                    ...
                                    <h2 class="fw-bolder"><?php echo e($pipelineskpd + $pipelineumkm + $pipelinepasar); ?></h2>
...
<?php echo $__env->make('analis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Analis/Resources/views/index.blade.php ENDPATH**/ ?>