                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo e(optional(optional($proposal->keteranganusaha)->jenispasar)->nama_pasar); ?></td>
                                            <td style="text-align: center"><?php echo e(number_format($proposal->harga)); ?></td>
                                            ...
                                            <td style="text-align: center">
                                                <a href="/kabag/pasar/proposal/<?php echo e($proposal->id); ?>" class="btn btn-outline-info btn-sm round">Detail</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/pasar/proposal/index.blade.php ENDPATH**/ ?>