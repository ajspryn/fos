...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis') || Request::is('simulasi') || Request::is('dirbis/*/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="menu" class="menu-icon tf-icons"></i>
                <div data-i18n="Dashboard">Dashboard</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/skpd/create') ? 'active' : ''); ?>">
                    <a href="/dirbis/skpd/create" class="menu-link">
                        <div data-i18n="SKPD">SKPD</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/pasar/create') ? 'active' : ''); ?>">
                    <a href="/dirbis/pasar/create" class="menu-link">
                        <div data-i18n="Pasar">Pasar</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/umkm/create') ? 'active' : ''); ?>">
                    <a href="/dirbis/umkm/create" class="menu-link">
                        <div data-i18n="UMKM">UMKM</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/ppr/create') ? 'active' : ''); ?>">
                    <a href="/dirbis/ppr/create" class="menu-link">
                        <div data-i18n="PPR">PPR</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/p3k/create') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis/skpd*') && !Request::is('dirbis/skpd/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis/skpd/nasabah') ? 'active' : ''); ?>">
                    <a href="/dirbis/skpd/nasabah" class="menu-link">
                        <div data-i18n="Data Nasabah">Data Nasabah</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/skpd/komite') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/skpd/proposal') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis/pasar*') && !Request::is('dirbis/pasar/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="circle" class="menu-icon tf-icons"></i>
                <div data-i18n="PASAR">PASAR</div>
                <?php if($data > 0): ?>
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis/pasar/nasabah') ? 'active' : ''); ?>">
                    <a href="/dirbis/pasar/nasabah" class="menu-link">
                        <div data-i18n="Data Nasabah">Data Nasabah</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/pasar/komite') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/pasar/proposal') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis/umkm*') && !Request::is('dirbis/umkm/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="circle" class="menu-icon tf-icons"></i>
                <div data-i18n="UMKM">UMKM</div>
                <?php if($b > 0): ?>
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis/umkm/nasabah') ? 'active' : ''); ?>">
                    <a href="/dirbis/umkm/nasabah" class="menu-link">
                        <div data-i18n="Data Nasabah">Data Nasabah</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/umkm/komite') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/umkm/proposal') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis/ppr*') && !Request::is('dirbis/ppr/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="circle" class="menu-icon tf-icons"></i>
                <div data-i18n="PPR">PPR</div>
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis/ppr/nasabah') ? 'active' : ''); ?>">
                    <a href="/dirbis/ppr/nasabah" class="menu-link">
                        <div data-i18n="Data Nasabah">Data Nasabah</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/ppr/komite') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/ppr/proposal') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('dirbis/p3k*') && !Request::is('dirbis/p3k/create') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="circle" class="menu-icon tf-icons"></i>
                <div data-i18n="P3K">P3K</div>
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('dirbis/p3k/nasabah') ? 'active' : ''); ?>">
                    <a href="/dirbis/p3k/nasabah" class="menu-link">
                        <div data-i18n="Data Nasabah">Data Nasabah</div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is('dirbis/p3k/komite') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('dirbis/p3k/proposal') ? 'active' : ''); ?>">
...
<!-- END: Main Menu-->
<?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>