                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                                            ...
                                                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                                                method="POST" action="/dirbis/pasar/komite">
                                                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="tab-pane" id="keuangan"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="<?php echo e(asset('storage/' . $nota->foto)); ?>" alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">Foto Kios / Los :
                                                                <?php echo e($fototoko->kategori); ?>

                                                            </h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                <?php echo e($fototoko->created_at->diffForhumans()); ?></small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="<?php echo e(asset('storage/' . $fototoko->foto)); ?>"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
...
<?php echo $__env->make('dirbis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/pasar/komite/lihat.blade.php ENDPATH**/ ?>