                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>: Rp.
                                                                                <?php echo e(number_format($pengeluaran_lain)); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                    ...
                                                    <div class="card-body invoice-padding pt-0">
                                                        <div class="row invoice-spacing">
                                                            ...
                                                            <div class="col-xl-5 p-0 mt-xl-0 mt-2">
                                                                <?php if($history->status_id == 4 && $history->jabatan_id == 4): ?>
                                                                    <?php if($nilai_idir >= 80 || $nilai_idir < 0): ?>
                                                                        <div class="card-body">
...
<?php echo $__env->make('dirbis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/umkm/komite/lihat.blade.php ENDPATH**/ ?>