                            ...
                            <div class="card">
                                    ...
                                    <div class="row invoice-spacing">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>: <?php echo e($pembiayaan->tgl_pembiayaan); ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="fw-bold">:
                                                                <?php echo e($pembiayaan->nasabahh->nama_nasabah); ?></span></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="fw-bold">: Rp.
                                                                <?php echo e(number_format($pembiayaan->omset)); ?></span></td>
                                                    </tr>
                                                    <div class="col-md-3">
                                                        <tr>
                                                            <td class="pe-1"> &emsp; HPP</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->hpp)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pe-1">&emsp; Transport</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->trasport)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pe-1">&emsp; Telpon</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->telpon)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pe-1">&emsp; Listrik</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->listrik)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pe-1">&emsp; Karyawan</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->karyawan)); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="pe-1">&emsp; Sewa Kios / Los</td>
                                                            <td>: Rp. <?php echo e(number_format($pembiayaan->sewa)); ?></td>
                                                        </tr>
                                                    </div>
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>: Rp.
                                                            <?php echo e(number_format($angsuran)); ?></span></td>
                                                    </tr>

                                                    <tr>
                                                        <td class="pe-1">Cicilan Bank Lain</td>
                                                        <td>: Rp. <?php echo e(number_format($cicilan)); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Kebutuhan Keluarga</td>
                                                        <td>: Rp. <?php echo e(number_format($pengeluaran_lain)); ?></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <h6>Sisa Pendapatan Bersih : Rp.
                                                <?php echo e(number_format($laba_bersih - $total_pengeluaran)); ?></h6>
                                            <hr>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: Rp. <?php echo e(number_format($harga_jual)); ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: Rp. <?php echo e(number_format($angsuran)); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1 mt-1">IDIR</td>
                                                        <td><span class="fw-bold">: <?php echo e($nilai_idir); ?>
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row invoice-spacing">
                                            ...
                                            <div class="col-xl-5 p-0 mt-xl-0 mt-2">
                                                <?php if($history->status_id == 4 && $history->jabatan_id == 3): ?>
                                                    <?php if($nilai_idir >= 80 || $nilai_idir < 0): ?>
                                                    <div class="card-body">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <iframe src="<?php echo e(asset('storage/' . $deviasi->dokumen_deviasi)); ?>" class="d-block w-100"
                                ...
                                <hr class="invoice-spacing" />
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <?php if($fotodiri && $fotodiri->foto): ?>
                                                        ...
                                                        <!--/ post img -->
                                                    <?php else: ?>
                                                        <div class="text-center text-muted">Foto diri belum tersedia.</div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <?php if($fotoktp && $fotoktp->foto): ?>
                                                        <div class="d-flex justify-content-start align-items-center mb-1">
                                                            <div>
                                                        ...
                                                        <!--/ post img -->
                                                    <?php else: ?>
                                                        <div class="text-center text-muted">Foto KTP belum tersedia.</div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <?php if($fotodiribersamaktp && $fotodiribersamaktp->foto): ?>
                                                        <div class="d-flex justify-content-start align-items-center mb-1">
                                                            <div>
                                                        ...
                                                        <!--/ post img -->
                                                    <?php else: ?>
                                                        <div class="text-center text-muted">Foto diri bersama KTP belum tersedia.</div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <?php if($fotokk && $fotokk->foto): ?>
                                                        <div class="d-flex justify-content-start align-items-center mb-1">
                                                            <div>
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="<?php echo e(asset('storage/' . $fotokk->foto)); ?>"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    <?php else: ?>
                                                        <div class="text-center text-muted">Foto Kartu Keluarga belum tersedia.</div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <iframe src="<?php echo e(asset('storage/' . $pembiayaan->dokumen_keuangan)); ?>" class="d-block w-100"
                                                                ...
                                                                <li class="timeline-item">
                                                                    ...
                                                                    <div class="timeline-event">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                            class="timeline-event-time" style="text-align: right"><?php echo e($timeline->created_at->isoformat('dddd, D MMMM Y')); ?> 
                                                                        ...
                                                                        <?php if($arr==-1): ?>
                                                                        <?php else: ?>
                                                                        <span class="timeline-event-time" >Waktu Diproses : <?php echo e($selisih); ?></span>
                                                                        <?php endif; ?>
...
<?php echo $__env->make('analis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Analis/Resources/views/umkm/komite/lihat.blade.php ENDPATH**/ ?>