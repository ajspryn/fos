                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag/umkm/komite">UMKM</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/kabag/umkm/komite">Komite</a>
                                    </li>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php $__empty_1 = true; $__currentLoopData = $komites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center"><?php echo e(number_format($komite->nominal_pembiayaan)); ?></td>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="/kabag/umkm/komite/<?php echo e($komite->id); ?>" class="btn btn-outline-info btn-sm round">Detail</a>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/umkm/komite/index.blade.php ENDPATH**/ ?>