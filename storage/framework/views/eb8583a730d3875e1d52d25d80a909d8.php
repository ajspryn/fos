                                        ...
                                        <div class="tab-pane" id="ideb" role="tabpanel"
                                            ...
                                            <?php if($pembiayaan->nasabah->status_pernikahan == 'Menikah'): ?>
                                                ...
                                                <?php if($dokumenIdebPasangan): ?>
                                                    <iframe src="<?php echo e(asset('storage/' . $dokumenIdebPasangan->foto)); ?>"
                                                        class="d-block w-100" height="600"></iframe>
                                                <?php else: ?>
                                                    <center>
                                                        <br />
...
<?php echo $__env->make('dirbis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/p3k/komite/lihat.blade.php ENDPATH**/ ?>