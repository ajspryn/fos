                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag/ultra_mikro/komite">Ultra Mikro</a>
                                    </li>
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="midCenter"><?php echo e($proposal->tanggal_pengajuan ? \Carbon\Carbon::parse($proposal->tanggal_pengajuan)->format('d-m-Y') : '-'); ?></td>
                                            ...
                                            <td class="midCenter">Rp. <?php echo e(number_format((int) ($proposal->nominal_pembiayaan ?? 0), 0, ',', '.')); ?></td>
                                            <td class="midCenter"><?php echo e($proposal->tenor); ?></td>
                                            <td class="midCenter">
                                            ...
                                            <td style="text-align: center">
                                                <a href="/kabag/ultra_mikro/komite/<?php echo e($proposal->id); ?>" class="btn btn-outline-info btn-sm round">Detail</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/ultra_mikro/komite/index.blade.php ENDPATH**/ ?>