                                    ...
                                    <div class="tab-content pt-1">
                                            ...
                                            <div class="col-xl-12 col-md-8 col-12">
                                                <div class="card invoice-preview-card">
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>: <?php echo e($pembiayaan->akad->nama_akad); ?>
                                                    ...
                                                    <?php if($deviasi): ?>
                                                        <?php
                                                            $deviasiItems = [];
                                                            if (is_iterable($deviasi)) {
                                                                $deviasiItems = $deviasi;
                                                            } elseif (!empty($deviasi)) {
                                                                $deviasiItems = [$deviasi];
                                                            }
                                                        ?>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <?php $__currentLoopData = $deviasiItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $devItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <h4 class="text-center">Deviasi <?php echo e(optional($devItem)->kategori_deviasi ?? ''); ?></h4>
                                                                                <?php if(optional($devItem)->dokumen_deviasi): ?>
                                                                                    <iframe
                                                                                        src="<?php echo e(asset('storage/' . optional($devItem)->dokumen_deviasi)); ?>"
                                                                                        class="d-block w-100" height="500"
                                                                                        weight='900'></iframe>
                                                                                    <br /><br />
                                                                                <?php else: ?>
                                                                                    <p class="text-center">Dokumen deviasi tidak tersedia.</p>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <img class="img-fluid rounded mb-75"
                                                            src="<?php echo e(asset('storage/' . $foto->foto)); ?>"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                            ...
                                            <?php $__currentLoopData = $jaminans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jaminan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="<?php echo e(asset('storage/' . $jaminan->dokumen_jaminan)); ?>"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="keuangan" role="tabpanel"
                                            ...
                                            <embed type="application/pdf"
                                                src="<?php echo e(asset('storage/' . $pembiayaan->dokumen_keuangan)); ?>"
                                                width="1000" height="900">
                                            <embed type="application/pdf"
                                                src="<?php echo e(asset('storage/' . $pembiayaan->dokumen_slip_gaji)); ?>"
                                                width="1000" height="900">
                                        </div>
                                        <div class="tab-pane" id="ideb" role="tabpanel"
                                            aria-labelledby="settings-tab-justified">
                                            <?php if($ideb): ?>
                                            <iframe src="<?php echo e(asset('storage/' . $ideb->foto)); ?>" frameborder="0"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-12 mx-50 pb-5">
                                ...
                                <div class="card-body">
                                    <?php if($konfirmasi): ?>
                                        <img src="<?php echo e(asset('storage/' . $konfirmasi->foto)); ?>" class="d-block w-100"
                                            height='500'>
                                    <?php else: ?>
                                        <p class="text-center">Konfirmasi bendahara belum di-upload.</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('dirbis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/skpd/komite/lihat.blade.php ENDPATH**/ ?>