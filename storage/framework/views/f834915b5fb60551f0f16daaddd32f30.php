...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?php echo e(Request::is('p3k') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('p3k/pipeline*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('p3k/nasabah*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('p3k/komite*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('p3k/proposal*') || Request::is('p3k/revisi*') ? 'open' : ''); ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i data-feather="clipboard" class="menu-icon tf-icons"></i>
                <div data-i18n="Proposal">Proposal</div>
                <?php if($proposalP3k + $notifRevisi > 0): ?>
                    <div class="badge bg-label-success rounded-pill ms-auto"><?php echo e($proposalP3k + $notifRevisi); ?></div>
                <?php endif; ?>
            </a>
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('p3k/proposal*') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('p3k/revisi*') ? 'active' : ''); ?>">
...
<!-- END: Main Menu-->
<?php /**PATH /Users/ajspryn/Project/fos/Modules/P3k/Resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>