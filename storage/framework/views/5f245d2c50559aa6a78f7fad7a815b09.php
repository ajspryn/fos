                                    ...
                                    <div class="card-body" style="background:linear-gradient(118deg,#ea5455,rgba(234,84,85,.7));border-radius:inherit;">
                                        ...
                                        <div class="bg-white rounded p-1 mb-1">
                                            ...
                                            <h5 class="mb-0 text-danger fw-bolder">
                                                ...
                                                <small class="text-body fw-normal font-small-3"> / 100.000.000</small>
                                            </h5>
                                        </div>
                                        <?php ($pct = min(round($cair / 100000000 * 100), 100)); ?>
        ...
        (function () {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: <?php echo json_encode($pdatainstansis); ?>,
...
<?php echo $__env->make('skpd::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Skpd/Resources/views/index.blade.php ENDPATH**/ ?>