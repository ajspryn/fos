        ...
        <section class="section-py front-hero">
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo e(asset('foto2.png')); ?>"
                        ...
                        <div class="card h-100 product-card">
                            <a href="/form/skpd" class="text-decoration-none">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset('Bogor.png')); ?>" class="front-product-image" loading="lazy" decoding="async" alt="Pembiayaan SKPD" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card h-100 product-card">
                            <a href="/form/p3k" class="text-decoration-none">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset('Bogor.png')); ?>" class="front-product-image" loading="lazy" decoding="async" alt="Pembiayaan P3K" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card h-100 product-card">
                            <a data-bs-toggle="modal" data-bs-target="#pilihPasarUmkm" role="button" class="text-decoration-none">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset('pasar.png')); ?>" class="front-product-image" loading="lazy" decoding="async" alt="Pembiayaan Pasar & UMKM" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card h-100 product-card">
                            <a data-bs-toggle="modal" data-bs-target="#pilihPendapatan" role="button" class="text-decoration-none">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset('ppr.png')); ?>" class="front-product-image" loading="lazy" decoding="async" alt="PPR - Pembiayaan Pemilikan Rumah" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card h-100 product-card">
                            <a data-bs-toggle="modal" data-bs-target="#modalUltraMikro" role="button" class="text-decoration-none">
                                <div class="card-body text-center">
                                    <img src="<?php echo e(asset('um.png')); ?>" class="front-product-image" loading="lazy" decoding="async" alt="Pembiayaan Ultra Mikro" />
...
<?php echo $__env->make('layouts.front.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/resources/views/index.blade.php ENDPATH**/ ?>