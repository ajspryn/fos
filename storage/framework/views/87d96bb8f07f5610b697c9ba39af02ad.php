                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="card-body invoice-padding pt-0">
                                        <div class="row invoice-spacing">
                                            ...
                                            <div class="col-xl-5 p-0 mt-xl-0 mt-2">
                                                <?php if($history->status_id == 4 && $history->jabatan_id == 2): ?>
                                                <div class="card-body">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                    ...
                                                    <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                                        method="POST" action="/kabag/umkm/komite">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <div class="card-body">
                                                                                                                                                <iframe src="<?php echo e(asset('storage/' . optional($deviasi)->dokumen_deviasi)); ?>" class="d-block w-100"
                                ...
                                <hr class="invoice-spacing" />
                                        ...
                                        <iframe src="<?php echo e(asset('storage/' . optional($pembiayaan)->dokumen_keuangan)); ?>" class="d-block w-100"
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/umkm/komite/lihat.blade.php ENDPATH**/ ?>