                        ...
                        <div class="col-xl-9 col-md-6 col-12">
                            <div class="card card-statistics">
                                <div class="card-header">
                                    <h4 class="card-title">Statistik Tahun <?php echo e(date('Y')); ?></h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0"><?php echo e($ditolak); ?>

                                                        <span
                                                            style="font-weight: normal; font-size:12px; vertical-align:middle;">
                                                            Ditolak</span>
                                                    </h4>
                                                    <h4 class="fw-bolder mb-0"><?php echo e($proposalBatal); ?>
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0"><?php echo e($jmlProposalSelesai); ?></h4>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-8">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h2 class="fw-bolder"><?php echo e('Rp ' . number_format($jmlDisburse, 0, ',', '.')); ?></h2>
...
<?php echo $__env->make('dirbis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Dirbis/Resources/views/index.blade.php ENDPATH**/ ?>