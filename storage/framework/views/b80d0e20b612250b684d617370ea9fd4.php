                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag/ppr/proposal">PPR</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/kabag/ppr/proposal">Proposal</a>
                                    </li>
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="midCenter"><?php echo e($proposal->created_at ? date_format($proposal->created_at, 'd-m-Y') : '-'); ?></td>
                                            ...
                                            <td style="text-align: center">
                                                <a href="/kabag/ppr/proposal/<?php echo e($proposal->id); ?>" class="btn btn-outline-info btn-sm round">Detail</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/ppr/proposal/index.blade.php ENDPATH**/ ?>