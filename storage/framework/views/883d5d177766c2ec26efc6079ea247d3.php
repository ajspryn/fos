                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-3">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <?php $__currentLoopData = $deviasiItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $devItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <?php if(optional($devItem)->dokumen_deviasi): ?>
                                                                                <iframe src="<?php echo e(asset('storage/' . optional($devItem)->dokumen_deviasi)); ?>" class="d-block w-100" height="500"></iframe>
                                                                                <br /><br />
                                                                            <?php else: ?>
                                        ...
                                        width= "1000" height="900"></iframe>
                                            <embed type="application/pdf" src="<?php echo e(asset('storage/' . $ideb->foto)); ?>"
                                                width="1000" height="900">
                                            <?php else: ?>
...
<?php echo $__env->make('analis::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Analis/Resources/views/skpd/komite/lihat.blade.php ENDPATH**/ ?>