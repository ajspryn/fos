...
<div class="app-content content">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <?php if($userPipelinesCurrentMonth->isEmpty()): ?>
            <div class="alert alert-danger d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-1 mb-4">
                <div>
                    <div class="fw-semibold">Anda belum memiliki data pipeline bulan <?php echo e($currentMonth . ' ' . $currentYear); ?>.</div>
        ...
        <div class="content-header row mb-3">
            <div class="content-header-left col-12">
                <h3 class="content-header-title float-start mb-0">Data Pipeline <?php echo e(Auth::user()->name); ?></h3>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm mb-0">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php $__empty_1 = true; $__currentLoopData = $userPipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userPipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                            <td class="text-center"><?php echo e($userPipeline->tahun); ?></td>
                                            <td class="text-center"><?php echo e($userPipeline->bulan); ?></td>
                                            <td class="text-end">Rp<?php echo e(number_format($userPipeline->nominal_target, 0, ',', '.')); ?></td>
                                            <td class="text-end">Rp<?php echo e(number_format($userPipeline->nominal_realisasi, 0, ',', '.')); ?></td>
                                            <td class="text-end">Rp<?php echo e(number_format($userPipeline->nominal_on_process, 0, ',', '.')); ?></td>
                                            <td class="text-center">
                                                <?php if($userPipeline->nominal_realisasi >= $userPipeline->nominal_target): ?>
                                            ...
                                            <td class="text-center">
                                                <a href="/p3k/userPipeline/<?php echo e($userPipeline->id); ?>" class="btn btn-sm btn-outline-info">Detail</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('p3k::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/P3k/Resources/views/pipeline/index.blade.php ENDPATH**/ ?>