                ...
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example">
                        ...
                        <div class="bs-stepper-content">
                            <form method="POST" action="/p3k/proposal/<?php echo e($pembiayaan->id); ?>" id="proposalP3k"
                                ...
                                <div id="form" class="content" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="user_id" id="ao"
                                                ...
                                                <option value=""></option>
                                                <?php $__currentLoopData = $aos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($ao->user->id); ?>"
                                                        <?php echo e($pembiayaan->user_id == $ao->user->id ? 'selected' : ''); ?>>
                                                        <?php echo e($ao->user->name); ?></option>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="pengajuan_fas_aktif_ke" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->pengajuan_fas_aktif_ke); ?>" disabled />
                                        </div>
                                        <?php if($pembiayaan->pengajuan_fas_aktif_ke >= 2): ?>
                                            <div class="row">
                                                <div class="mb-1 col-md-6">
                                                    ...
                                                    <input type="text" name="total_angsuran_btb_fas_aktif"
                                                        ...
                                                        value="<?php echo e($pembiayaan->total_angsuran_btb_fas_aktif); ?> "disabled />
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="tanggal" class="form-control flatpickr-basic"
                                                ...
                                                value="<?php echo e(date('d-m-Y', strtotime($pembiayaan->tanggal_pengajuan))); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="jenis_penggunaan" id="jenispenggunaan"
                                                ...
                                                <option value="Modal Kerja"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Modal Kerja' ? 'selected' : ''); ?>>
                                                    Modal Kerja</option>
                                                <option value="Renovasi Rumah"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Renovasi Rumah' ? 'selected' : ''); ?>>
                                                    Renovasi Rumah</option>
                                                <option value="Pendidikan"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Pendidikan' ? 'selected' : ''); ?>>
                                                    Pendidikan</option>
                                                <option value="Kesehatan"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Kesehatan' ? 'selected' : ''); ?>>
                                                    Kesehatan</option>
                                                <option value="Pernikahan"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Pernikahan' ? 'selected' : ''); ?>>
                                                    Pernikahan</option>
                                                <option value="Pembelian Kendaraan Bermotor"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Pembelian Kendaraan Bermotor' ? 'selected' : ''); ?>>
                                                    Pembelian Kendaraan Bermotor</option>
                                                <option value="Ibadah Umroh"
                                                    <?php echo e($pembiayaan->jenis_penggunaan == 'Ibadah Umroh' ? 'selected' : ''); ?>>
                                                    Ibadah Umroh</option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nominal_pembiayaan"
                                                ...
                                                id="nominalPembiayaan" value="<?php echo e($pembiayaan->nominal_pembiayaan); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="tenor" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->tenor); ?>" disabled />
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nama_nasabah" id="nama"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->nama_nasabah); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="no_ktp" id="noktp" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->no_ktp); ?>" disabled />
                                        </div>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="tempat_lahir" id="tempat_lahir"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->tempat_lahir); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="tgl_lahir" class="form-control flatpickr-basic"
                                                ...
                                                value="<?php echo e(date('d-m-Y', strtotime($pembiayaan->nasabah->tgl_lahir))); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="radio" name="jenis_kelamin" class="form-check-input"
                                                    id="pria" value="Pria"
                                                    <?php echo e($pembiayaan->nasabah->jenis_kelamin == 'Pria' ? 'checked' : ''); ?>
                                                ...
                                                <input type="radio" name="jenis_kelamin" class="form-check-input"
                                                    ...
                                                    <?php echo e($pembiayaan->nasabah->jenis_kelamin == 'Wanita' ? 'checked' : ''); ?>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="agama" id="agama"
                                                ...
                                                <option value="Islam"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Islam' ? 'selected' : ''); ?>>Islam
                                                </option>
                                                <option value="Protestan"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Protestan' ? 'selected' : ''); ?>>
                                                    Protestan</option>
                                                <option value="Katholik"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Katholik' ? 'selected' : ''); ?>>
                                                    Katholik</option>
                                                <option value="Budha"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Budha' ? 'selected' : ''); ?>>Budha
                                                </option>
                                                <option value="Hindu"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Hindu' ? 'selected' : ''); ?>>Hindu
                                                </option>
                                                <option value="Kong Hu Chu"
                                                    <?php echo e($pembiayaan->nasabah->agama == 'Kong Hu Chu' ? 'selected' : ''); ?>>
                                                    Kong Hu Chu</option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="tinggi_badan" id="tinggiBadan"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->tinggi_badan); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="berat_badan" id="beratBadan"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->berat_badan); ?>" disabled />
                                        </div>
                                        <div>
                                                            ...
                                                            <div class="col-md-4 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->alamat); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-1 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->rt); ?>" disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-1 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->rw); ?>" disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->desa_kelurahan); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->kecamatan); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->kabkota); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->provinsi); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-1 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        ...
                                                                        value="<?php echo e($pembiayaan->nasabah->kd_pos); ?>"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-4 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="<?php echo e($pembiayaan->nasabah->alamat_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="000"
                                                                            value="<?php echo e($pembiayaan->nasabah->rt_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="000"
                                                                            value="<?php echo e($pembiayaan->nasabah->rw_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Kelurahan"
                                                                            value="<?php echo e($pembiayaan->nasabah->desa_kelurahan_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Kecamatan"
                                                                            value="<?php echo e($pembiayaan->nasabah->kecamatan_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Kabupaten/Kota"
                                                                            value="<?php echo e($pembiayaan->nasabah->kabkota_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Provinsi"
                                                                            value="<?php echo e($pembiayaan->nasabah->provinsi_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            ...
                                                                            placeholder="16XXX"
                                                                            value="<?php echo e($pembiayaan->nasabah->kd_pos_domisili); ?>"
                                                                            disabled />
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="status_pernikahan" id="statusPernikahan"
                                                ...
                                                <option value="Belum Menikah"
                                                    <?php echo e($pembiayaan->nasabah->status_pernikahan == 'Belum Menikah' ? 'selected' : ''); ?>>
                                                    Belum Menikah</option>
                                                <option value="Menikah"
                                                    <?php echo e($pembiayaan->nasabah->status_pernikahan == 'Menikah' ? 'selected' : ''); ?>>
                                                    Menikah</option>
                                                <option value="Janda/Duda - Meninggal"
                                                    <?php echo e($pembiayaan->nasabah->status_pernikahan == 'Janda/Duda - Meninggal' ? 'selected' : ''); ?>>
                                                    Janda/Duda - Meninggal</option>
                                                <option value="Janda/Duda - Cerai"
                                                    <?php echo e($pembiayaan->nasabah->status_pernikahan == 'Janda/Duda - Cerai' ? 'selected' : ''); ?>>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="jml_tanggungan" id="jmlTanggungan"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->jml_tanggungan); ?>" disabled />
                                        </div>
                                        <?php if($pembiayaan->nasabah->status_pernikahan == 'Menikah'): ?>
                                            <div class="mb-1 col-md-6 hide" id="ifMenikahNamaPasangan">
                                                ...
                                                <input type="text" name="nama_pasangan_nasabah" id="namaPasangan"
                                                    ...
                                                    value="<?php echo e($pembiayaan->nasabah->nama_pasangan_nasabah); ?>" disabled />
                                            </div>
                                            <div class="mb-1 col-md-6 hide" id="ifMenikahKtpPasangan">
                                                ...
                                                <input type="number" name="no_ktp_pasangan" id="noKtpPasangan"
                                                    ...
                                                    value="<?php echo e($pembiayaan->nasabah->no_ktp_pasangan); ?>" disabled />
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="no_telp" id="noTelp" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->no_telp); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="no_hp" id="noHp" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->no_hp); ?>" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($pembiayaan->nasabah->status_pernikahan != 'Belum Menikah'): ?>
                                            <?php if($pembiayaan->nasabah->status_pernikahan == 'Menikah'): ?>
                                                <div class="mb-1 col-md-4">
                                                    <button type="button" class="btn btn-md btn-primary w-100"
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nama_orang_terdekat" id="namaOt"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->orangTerdekat->nama_orang_terdekat); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="no_telp_orang_terdekat" id="noTelpOt"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->orangTerdekat->no_telp_orang_terdekat); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-12">
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->alamat_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->rt_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->rw_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kelurahan"
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->desa_kelurahan_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kecamatan"
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->kecamatan_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kabupaten/Kota"
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->kabkota_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Provinsi"
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->provinsi_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orangTerdekat->kd_pos_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="dinas" id="dinas" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->pekerjaan->dinas); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nama_unit_kerja" id="namaUnitKerja"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->pekerjaan->nama_unit_kerja); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="jabatan" id="jabatan" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->pekerjaan->jabatan); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="no_sk" id="noSk" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->pekerjaan->no_sk); ?>" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="gaji_pokok" class="form-control numeral-mask"
                                                placeholder="Rp." id="gajiPokok" value="<?php echo e($pembiayaan->gaji_pokok); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="gaji_tpp" class="form-control numeral-mask"
                                                placeholder="Rp." id="gajiTpp" value="<?php echo e($pembiayaan->gaji_tpp); ?>"
                                                disabled />
                                        </div>
                                        <?php if($pembiayaan->nasabah->status_pernikahan == 'Menikah'): ?>
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" name="gaji_pasangan"
                                                    ...
                                                    value="0" value="<?php echo e($pembiayaan->gaji_pasangan); ?>" disabled />
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="pengeluaran_lainnya"
                                                ...
                                                value="<?php echo e($pembiayaan->pengeluaran_lainnya); ?>" disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="keterangan_pengeluaran_lainnya"
                                                ...
                                                value="<?php echo e($pembiayaan->keterangan_pengeluaran_lainnya); ?>" disabled />
                                        </div>
                                    </div>
                                    <br />
                                    <br />
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                            ...
                                            <iframe src="<?php echo e(asset('storage/' . $fotoKtp->foto)); ?>" class="d-block w-100"
                                                height="600"></iframe>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                            ...
                                            <iframe src="<?php echo e(asset('storage/' . $fotoKartuKeluarga->foto)); ?>"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                            ...
                                            <iframe src="<?php echo e(asset('storage/' . $fotoNpwp->foto)); ?>" class="d-block w-100"
                                                height="600"></iframe>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-sm-5 mx-50 pb-5">
                                                ...
                                                <iframe src="<?php echo e(asset('storage/' . $fotoKtpPasangan->foto)); ?>"
                                                    class="d-block w-100" height="600"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-sm-5 mx-50 pb-5">
                                                ...
                                                <iframe src="<?php echo e(asset('storage/' . $fotoStatusPernikahan->foto)); ?>"
                                                    class="d-block w-100" height="600"></iframe>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('p3k::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/P3k/Resources/views/proposal/lihat.blade.php ENDPATH**/ ?>