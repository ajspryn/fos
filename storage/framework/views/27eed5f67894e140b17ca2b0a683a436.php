                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $cicilanpasangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ideppasangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center">
                                                                                <?php echo e($ideppasangan->kol); ?></td>
                                                                        </tr>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo e($kepalapasar->kategori); ?></td>
                                                                        <td style="text-align: center">
                                            ...
                                            <div class="card-body invoice-padding pt-0">
                                                <div class="row invoice-spacing">
                                                    ...
                                                    <div class="col-xl-9 p-0 mt-xl-0 mt-2">
                                                        ...
                                                        <?php endif; ?>
                                                        <form action="/pasar/cetak" target="_blank" class="d-inline-block m-0">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-sm-5 mx-50 pb-5">
                                                            ...
                                                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                                                method="POST" action="/pasar/bonmurabahah"
...
<?php echo $__env->make('pasar::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Pasar/Resources/views/komite/lihat.blade.php ENDPATH**/ ?>