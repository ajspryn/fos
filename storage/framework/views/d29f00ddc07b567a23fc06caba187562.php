                ...
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example">
                        ...
                        <div class="bs-stepper-content">
                            <form method='POST' action="/skpd/proposal/<?php echo e($pembiayaan->id); ?>" class="needs-validation"
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="select2 w-100" name="user_id" id="ao" disabled>
                                                <option value="<?php echo e($pembiayaan->user->id); ?>"><?php echo e($pembiayaan->user->name); ?>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_jenis_penggunaan_id"
                                                ...
                                                <option value="<?php echo e($pembiayaan->jenis_penggunaan->id); ?>">
                                                    <?php echo e($pembiayaan->jenis_penggunaan->jenis_penggunaan); ?></option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_sektor_ekonomi_id" id="sektor"
                                                ...
                                                <?php $__currentLoopData = $sektors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sektor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($sektor->id); ?>"><?php echo e($sektor->nama_sektor_ekonomi); ?>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_akad_id" id="akad"
                                                ...
                                                <option value=""></option>
                                                <?php $__currentLoopData = $akads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $akad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($akad->id); ?>"><?php echo e($akad->nama_akad); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nominal_pembiayaan"
                                                ...
                                                id="nominal_pembiayaan" value="Rp.<?php echo e($pembiayaan->nominal_pembiayaan); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-4">
                                            ...
                                            <select class="select2 w-100" name="tenor" id="tenorr" disabled>
                                                <option value="<?php echo e($pembiayaan->tenor); ?>"><?php echo e($pembiayaan->tenor); ?> Bulan
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_status_perkawinan_id" id="status"
                                                disabled>
                                                <option value="<?php echo e($pembiayaan->nasabah->status_perkawinan->id); ?>">
                                                    <?php echo e($pembiayaan->nasabah->status_perkawinan->nama_status_perkawinan); ?>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_tanggungan_id" id="jumlahanak"
                                                disabled>
                                                <option value="<?php echo e($pembiayaan->nasabah->tanggungan->id); ?>">
                                                    <?php echo e($pembiayaan->nasabah->tanggungan->banyak_tanggungan); ?></option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" name="no_npwp" id="nonpwp" class="form-control"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->no_npwp); ?>" />
                                        </div>
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_jenis_nasabah_id" id="jenisNasabah"
                                                ...
                                                <option value=""></option>
                                                <?php $__currentLoopData = $jenisNasabahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisNasabah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($jenisNasabah->id); ?>">
                                                        <?php echo e($jenisNasabah->keterangan); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nama_orang_terdekat" id="namaot"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->orang_terdekat->nama_orang_terdekat); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="no_telp_orang_terdekat" id="notelpot"
                                                ...
                                                value="<?php echo e($pembiayaan->nasabah->orang_terdekat->no_telp_orang_terdekat); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-12">
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->alamat_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->rt_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->rw_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kelurahan"
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->desa_kelurahan_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kecamatan"
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->kecamatan_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Kabupaten/Kota"
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->kabkota_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Provinsi"
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->provinsi_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-1 col-12">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="<?php echo e($pembiayaan->nasabah->orang_terdekat->kd_pos_orang_terdekat); ?>"
                                                                    disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_instansi_id" id="namainstansi"
                                                disabled>
                                                <option value="<?php echo e($pembiayaan->instansi->id); ?>">
                                                    <?php echo e($pembiayaan->instansi->nama_instansi); ?></option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_golongan_id" id="golongan"
                                                disabled>
                                                <option value="<?php echo e($pembiayaan->golongan->id); ?>">
                                                    <?php echo e($pembiayaan->golongan->nama_golongan); ?></option>
                                            </select>
                                        </div>
                                        <div class="mb-1 col-md-4">
                                            ...
                                            <input type="text" name="jabatan" id="jabatan" class="form-control"
                                                placeholder="Masukkan Jabatan" value="<?php echo e($pembiayaan->jabatan); ?>"
                                                disabled />
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <select class="select2 w-100" name="skpd_jenis_jaminan_id" id="jaminan"
                                                disabled>
                                                <option value="<?php echo e($pembiayaan->jaminan->jenis_jaminan->id); ?>">
                                                    <?php echo e($pembiayaan->jaminan->jenis_jaminan->nama_jaminan); ?></option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="gaji_pokok" class="form-control numeral-mask"
                                                placeholder="Rp." id="gaji_pokok" value="<?php echo e($pembiayaan->gaji_pokok); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="pendapatan_lainnya"
                                                class="form-control numeral-mask" placeholder="Rp."
                                                value="<?php echo e($pembiayaan->pendapatan_lainnya); ?>" id="pendapatan_lainnya"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="gaji_tpp" class="form-control numeral-mask"
                                                ...
                                                value="<?php echo e($pembiayaan->gaji_tpp); ?>" disabled />
                                        </div>
                                    </div>
                                    <div class="content-header">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="pengeluaran_lainnya"
                                                class="form-control numeral-mask" placeholder="Rp."
                                                id="pengeluaranLainnya" value="<?php echo e($pembiayaan->pengeluaran_lainnya); ?>"
                                                disabled />
                                        </div>
                                        <div class="mb-1 col-md-6">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-5 mx-50 pb-5">
                                <h1 class="text-center mb-1" id="addNewCardTitle"><?php echo e($fotodiri->kategori); ?></h1>
                                <p class="text-center">Lampiran Foto Nasabah</p>
                                <div class="card-body">
                                    <img src="<?php echo e(asset('storage/' . $fotodiri->foto)); ?>" class="d-block w-100" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="fotoktp" tabindex="-1" aria-labelledby="addNewCardTitle"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-5 mx-50 pb-5">
                                <h1 class="text-center mb-1" id="addNewCardTitle"><?php echo e($fotoktp->kategori); ?></h1>
                                <p class="text-center">Lampiran Foto Nasabah</p>
                                <div class="card-body">
                                    <img src="<?php echo e(asset('storage/' . $fotoktp->foto)); ?>" class="d-block w-100" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="fotodiribersamaktp" tabindex="-1" aria-labelledby="addNewCardTitle"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-5 mx-50 pb-5">
                                <h1 class="text-center mb-1" id="addNewCardTitle"><?php echo e($fotodiribersamaktp->kategori); ?>

                                </h1>
                                <p class="text-center">Lampiran Foto Nasabah</p>
                                <div class="card-body">
                                    <img src="<?php echo e(asset('storage/' . $fotodiribersamaktp->foto)); ?>"
                                        class="d-block w-100" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="fotokk" tabindex="-1" aria-labelledby="addNewCardTitle"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <h1 class="text-center mb-1" id="addNewCardTitle"><?php echo e($fotokk->kategori); ?>

                                    </h1>
                                    <p class="text-center">Lampiran Foto Nasabah</p>
                                    <div class="card-body">
                                        <img src="<?php echo e(asset('storage/' . $fotokk->foto)); ?>" class="d-block w-100" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="fotostatus" tabindex="-1" aria-labelledby="addNewCardTitle"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    <h1 class="text-center mb-1" id="addNewCardTitle"><?php echo e($fotostatus->kategori); ?>

                                    </h1>
                                    <p class="text-center">Lampiran Foto Nasabah</p>
                                    <div class="card-body">
                                        <img src="<?php echo e(asset('storage/' . $fotostatus->foto)); ?>" class="d-block w-100" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('skpd::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Skpd/Resources/views/proposal/lihat.blade.php ENDPATH**/ ?>