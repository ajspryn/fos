...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?php echo e(Request::is('pasar') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('pasar/nasabah*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('pasar/komite*') ? 'active' : ''); ?>">
            <a href="/pasar/komite" class="menu-link">
                <i data-feather="file-text" class="menu-icon tf-icons"></i>
                <div data-i18n="Komite">Komite</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Request::is('pasar/proposal*') || Request::is('pasar/revisi*') ? 'open' : ''); ?>">
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php echo e(Request::is('pasar/proposal*') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is('pasar/revisi*') ? 'active' : ''); ?>">
...
<!-- END: Main Menu-->
<?php /**PATH /Users/ajspryn/Project/fos/Modules/Pasar/Resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>