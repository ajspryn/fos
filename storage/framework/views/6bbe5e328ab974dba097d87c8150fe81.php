                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <form method="GET" action="/p3k/revisi" class="d-flex gap-1">
                                    ...
                                    <?php if($search ?? null): ?><a href="/p3k/revisi" class="btn btn-outline-secondary btn-sm">Reset</a><?php endif; ?>
                                </form>
                            </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(strftime('%d %B %Y', strtotime($proposal->tanggal_pengajuan))); ?>
                                            ...
                                            <td><?php echo e($proposal->nasabah->alamat); ?>, RT <?php echo e($proposal->nasabah->rt); ?>/ RW
                                                ...
                                                <?php echo e($proposal->nasabah->provinsi); ?> <?php echo e($proposal->nasabah->kd_pos); ?>
                                            ...
                                            <td style="text-align: center">
                                                <a href="/p3k/revisi/<?php echo e($proposal->id); ?>/edit"
...
<?php echo $__env->make('p3k::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/P3k/Resources/views/revisi/index.blade.php ENDPATH**/ ?>