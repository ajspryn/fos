                    ...
                    <div class="row mb-2">
                        <div class="col-xl-4 col-md-6 col-12 mb-2 mb-md-0">
                            <div class="card h-100 mb-0">
                                <div class="card-body d-flex flex-column justify-content-center" style="background:linear-gradient(118deg,#28c76f,rgba(40,199,111,.7));border-radius:inherit;">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            <h5 class="text-white mb-25"><?php echo e(Auth::user()->name); ?></h5>
                                            <p class="text-white font-small-3 mb-0">Kabag Marketing</p>
                                        </div>
                                        <div class="avatar bg-white p-50">
                                            <div class="avatar-content">
                                                <i data-feather="briefcase" class="text-success font-medium-3"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-white rounded p-1">
                                        <p class="mb-25 text-body font-small-3 fw-bold">Total Pengajuan Masuk</p>
                                        <h2 class="mb-0 text-success fw-bolder"><?php echo e($proposalskpd + $a + $data + $proposalppr); ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0"><?php echo e($proposalskpd + $a + $data + $proposalppr); ?></h4>
                        ...
                        <div class="col-xl-3 col-md-6 col-6">
                            <div class="card text-center mb-0">
                                <div class="card-body">
                                    ...
                                    <h2 class="fw-bolder"><?php echo e(number_format($disburseskpd + $disburseumkm + $disbursepasar + $disburseppr, 0, ',', '.')); ?></h2>
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/index.blade.php ENDPATH**/ ?>