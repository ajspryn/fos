                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar avatar-online">
                            <img src="<?php echo e(Auth::user()->foto ? asset('storage/' . Auth::user()->foto) : asset('storage/avatar.png')); ?>" alt="avatar" class="w-px-40 h-auto rounded-circle" loading="lazy" />
                        </div>
                    </a>
...
<?php /**PATH /Users/ajspryn/Project/fos/resources/views/layouts/vuexy/navbar.blade.php ENDPATH**/ ?>