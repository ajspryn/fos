...
<head>
    ...
    <title>Cetak Proposal P3K - <?php echo e(Auth::user()->name ?? 'User'); ?></title>
    <style>
...
<body>
    <main class="print-sheet">
        <header class="header">
            <div><img src="<?php echo e(asset('logo.png')); ?>" alt="logo-left"></div>
            <div style="text-align:right"><img src="<?php echo e(asset('logoib.png')); ?>" alt="logo-right"></div>
        </header>
        ...
        <section class="section avoid-break">
            ...
            <table class="table">
                <tr>
                    ...
                    <td class="value"><?php echo e($pembiayaan->nasabah->nama_nasabah ?? '-'); ?></td>
                </tr>
                <tr>
                    <td class="label">Pekerjaan</td>
                    <td class="value"><?php echo e(optional($pembiayaan->nasabah->pekerjaan)->nama_pekerjaan ?? '-'); ?></td>
                </tr>
                <tr>
                    <td class="label">Unit Kerja</td>
                    <td class="value"><?php echo e(optional($pembiayaan->nasabah->pekerjaan)->nama_unit_kerja ?? '-'); ?></td>
                </tr>
                <tr>
                    <td class="label">Produk</td>
                    <td class="value"><?php echo e($pembiayaan->jenis_penggunaan ?? 'P3K'); ?></td>
                </tr>
                <tr>
                    <td class="label">Plafond</td>
                    <td class="value">Rp<?php echo e(number_format($pembiayaan->nominal_pembiayaan ?? 0,0,',','.')); ?></td>
                </tr>
                <tr>
                    <td class="label">Margin</td>
                    <td class="value"><?php echo e(number_format($pembiayaan->rate ?? 0,2,',','.')); ?> %</td>
                </tr>
                <tr>
                    <td class="label">Jangka Waktu</td>
                    <td class="value"><?php echo e($tenor ?? '-'); ?> Bulan</td>
                </tr>
                <tr>
                    <td class="label">Nama AO</td>
                    <td class="value"><?php echo e(Auth::user()->name ?? '-'); ?></td>
                </tr>
            </table>
        </section>
            ...
            <table style="width:100%;border-collapse:collapse;margin-top:12mm;">
                <tr>
                    ...
                    <td style="width:35%;border:1px solid #222;vertical-align:top;padding:6px;">
                        ...
                        <div style="border-top:1px solid #222;padding-top:4px;text-align:center;font-size:9pt;"><?php echo e($namaAO); ?></div>
                        <div style="font-weight:700;text-align:left;padding-top:2px;">TGL : <?php echo e(\Carbon\Carbon::now()->format('d-m-Y')); ?></div>
                    </td>
                    ...
                    <td style="width:35%;border:1px solid #222;vertical-align:top;padding:6px;">
                        ...
                        <div style="height:80px;"></div>
                        <div style="border-top:1px solid #222;padding-top:4px;text-align:center;font-size:9pt;"><?php echo e($namaKabag); ?></div>
        ...
        <footer class="small no-print" style="margin-top:8mm">Dicetak dari Aplikasi FOS BPRS BTB oleh: <?php echo e(Auth::user()->name ?? '-'); ?> pada <?php echo e(\Carbon\Carbon::now()->format('d-m-Y H:i')); ?></footer>
            ...
            <div class="legacy-page" style="page-break-before:always;">
                ...
                <section class="section avoid-break">
                    ...
                    <table class="table small" style="margin-top:6px;">
                        <tr>
                            ...
                            <td class="value"><?php echo e($pembiayaan->tanggal_pengajuan ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Penggunaan</td>
                            <td class="value"><?php echo e($pembiayaan->jenis_penggunaan ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Jenis Fasilitas</td>
                            <td class="value"><?php echo e($pembiayaan->akad ?? '-'); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="value"><?php echo e($pembiayaan->nasabah->no_hp ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Tlp Tdk Serumah</td>
                            <td class="value"><?php echo e(optional($pembiayaan->nasabah->orangTerdekat)->no_telp_orang_terdekat ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Alamat</td>
                            <td class="value"><?php echo e($pembiayaan->nasabah->alamat ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">No. KTP</td>
                            <td class="value"><?php echo e($pembiayaan->nasabah->no_ktp ?? '-'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Tempat, Tgl Lahir</td>
                            <td class="value"><?php echo e($pembiayaan->nasabah->tempat_lahir ?? '-'); ?>, <?php echo e(optional($pembiayaan->nasabah)->tgl_lahir ? strftime('%d-%m-%Y', strtotime($pembiayaan->nasabah->tgl_lahir)) : '-'); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:50%;vertical-align:top;padding-right:6px;">
                                ...
                                <table class="table small">
                                    <tr>
                                        ...
                                        <td class="value">Rp<?php echo e(number_format($pembiayaan->gaji_pokok ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Gaji TPP</td>
                                        <td class="value">Rp<?php echo e(number_format($pembiayaan->gaji_tpp ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Pendapatan Pasangan</td>
                                        <td class="value">Rp<?php echo e(number_format($pembiayaan->gaji_pasangan ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Jml. Pend. Join Income</td>
                                        <td class="value">Rp<?php echo e(number_format($pendapatanBersihJoinIncome ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Jumlah Pendapatan</td>
                                        <td class="value">Rp<?php echo e(number_format(($pembiayaan->gaji_pokok ?? 0) + ($pembiayaan->gaji_tpp ?? 0) + ($pembiayaan->gaji_pasangan ?? 0),0,',','.')); ?></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:50%;vertical-align:top;padding-left:6px;">
                                ...
                                <table class="table small">
                                    <tr>
                                        ...
                                        <td class="value">Rp<?php echo e(number_format($pembiayaan->total_angsuran_btb_fas_aktif ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Pengeluaran Lainnya</td>
                                        <td class="value">Rp<?php echo e(number_format($pembiayaan->pengeluaran_lainnya ?? 0,0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Jumlah Pengeluaran</td>
                                        <td class="value">Rp<?php echo e(number_format(($pembiayaan->total_angsuran_btb_fas_aktif ?? 0) + ($pembiayaan->pengeluaran_lainnya ?? 0),0,',','.')); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="label">Sisa Pendapatan Bersih</td>
                                        <td class="value">Rp<?php echo e(number_format($pendapatanBersih ?? 0,0,',','.')); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <section class="section avoid-break">
                    ...
                    <table class="table small">
                        ...
                        <tr>
                            ...
                            <td class="value">Rp<?php echo e(number_format($hargaJual ?? 0,0,',','.')); ?></td>
                        </tr>
                        <tr>
                            <td class="label">Jangka Waktu</td>
                            <td class="value"><?php echo e($tenor ?? '-'); ?> Bulan</td>
                        ...
                        <tr>
                            ...
                            <td class="value">Rp<?php echo e(number_format($angsuran ?? 0,0,',','.')); ?>/Bulan</td>
                            <td class="label">Jaminan</td>
                            <td class="value"><?php echo e($pembiayaan->jaminan ?? 'SK Pengangkatan/Terakhir'); ?></td>
                        </tr>
                        <tr>
                            <td class="label">DSR</td>
                            <td class="value"><?php echo e($dsr ?? '-'); ?> %</td>
                            <td class="label">DSR Join Income</td>
                            <td class="value"><?php echo e($dsrJoinIncome ?? '-'); ?> %</td>
                        </tr>
                    </table>
                </section>
                ...
                <section class="section avoid-break">
                    <table class="table" style="margin-top:8px;">
                        ...
                        <tr>
                            <td style="text-align:center;border:1px solid #222;padding:4px 6px;font-size:9pt;"><?php echo e($namaAO); ?></td>
                            <td style="text-align:center;border:1px solid #222;padding:4px 6px;font-size:9pt;"><?php echo e($namaKabag); ?></td>
                            <td style="text-align:center;border:1px solid #222;padding:4px 6px;font-size:9pt;"><?php echo e($namaAnalis); ?></td>
                        </tr>
                    </table>
                </section>
                ...
                <section class="section avoid-break">
                    ...
                    <?php if(!empty($catatanApprovals) && count($catatanApprovals)): ?>
                        <?php $__currentLoopData = $catatanApprovals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="margin-bottom:8px;">
                                <div style="font-weight:700"><?php echo e(optional($note->statushistory)->keterangan); ?> - <?php echo e(optional($note->jabatan)->keterangan); ?></div>
                                <div style="white-space:pre-wrap;"><?php echo nl2br(e($note->catatan)); ?></div>
                            </div>
...
<?php /**PATH /Users/ajspryn/Project/fos/Modules/P3k/Resources/views/cetak.blade.php ENDPATH**/ ?>