                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-around my-2 pt-75">
                        <div class="d-flex align-items-start me-2">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0"><?php echo e($nasabah->no_telp); ?></h5>
                        ...
                        <div class="d-flex align-items-start me-2">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">
                                    <?php echo e($pembiayaan->instansi->nama_instansi); ?></h5>
                                <small value="<?php echo e($pembiayaan->golongan->id); ?>">
                                    Golongan <?php echo e($pembiayaan->golongan->nama_golongan); ?></small>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        ...
                                        <span value="<?php echo e($nasabah->status_perkawinan->id); ?>">
                                            <?php echo e($nasabah->status_perkawinan->nama_status_perkawinan); ?></span>
                                    </li>
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-75">
                                        ...
                                        <span value="<?php echo e($pembiayaan->golongan->id); ?>">
                                            Golongan <?php echo e($pembiayaan->golongan->nama_golongan); ?></span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25"> Nama Instansi : </span>
                                        <span> <?php echo e($pembiayaan->instansi->nama_instansi); ?></span>
                                    </li>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><?php echo e($data->tanggal_pengajuan); ?> </td>
                                    <td style="text-align: center">Rp. <?php echo e(number_format($data->nominal_pembiayaan)); ?>
                                    ...
                                    <td style="text-align: center">Rp. <?php echo e(number_format($angsuran)); ?>

                                    </td>
                                    <td style="text-align: center">
                                        <?php echo e($data->jaminan->jenis_jaminan->nama_jaminan); ?>

                                    </td>
                                    <td style="text-align: center">
                                        <a href="/kabag/skpd/komite/<?php echo e($data->id); ?>"
...
<?php echo $__env->make('kabag::layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/fos/Modules/Kabag/Resources/views/skpd/nasabah/lihat.blade.php ENDPATH**/ ?>