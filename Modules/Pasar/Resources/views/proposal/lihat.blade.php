                                ...
                                <div id="form6" class="content" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                name="hpp" id="hpp"
                                                value="{{ number_format($pembiayaan->hpp) }}" disabled>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                ...
                                                value="{{ number_format($pembiayaan->listrik) }}" disabled>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="numeral-formatting"></small>Biaya
                                                Transport</label>
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                ...
                                                value="{{ number_format($pembiayaan->trasport) }}" disabled>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="numeral-formatting"></small>Biaya
                                                Karyawan</label>
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                ...
                                                value="{{ number_format($pembiayaan->karyawan) }}" disabled>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="numeral-formatting"></small>Biaya
                                                Telpon</label>
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                ...
                                                value="{{ number_format($pembiayaan->telpon) }}" disabled>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                name="sewa" id="sewa"
                                                value="{{ number_format($pembiayaan->sewa) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mt-3">
                                        <a class="btn btn-outline-secondary btn-prev" type="button">
