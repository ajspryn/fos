                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="tgl_pembiayaan" id="tgl_pembiayaan"
                                                ...
                                                placeholder="DD-MM-YYYY" value="{{ date('d-m-Y', strtotime($pembiayaan->tgl_pembiayaan)) }}"
                                                required />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="harga" class="form-control numeral-mask"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="tgl_lahir" class="form-control flatpickr-basic"
                                                ...
                                                value="{{ date('d-m-Y', strtotime($pembiayaan->nasabahh->tgl_lahir)) }}" required />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                ...
                                <div id="form7" class="content" role="tabpanel"
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                            name="omset" id="omset"
                                            value="{{ number_format($pembiayaan->omset) }}" required>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                                name="hpp" id="hpp"
                                                value="{{ number_format($pembiayaan->hpp) }}">
                                        </div>
                                        <div class="mb-1 col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="aset" id="aset" class="form-control"
                                                placeholder="Masukan Kepemilikkan Aset"
