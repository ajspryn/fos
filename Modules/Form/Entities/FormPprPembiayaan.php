...
class FormPprPembiayaan extends Model
{
    ...
    {
        return $this->hasOne(PprPembiayaanHistory::class, 'form_ppr_pembiayaan_id')->latestOfMany();
    }

    public function histories()
    {
        return $this->hasMany(PprPembiayaanHistory::class, 'form_ppr_pembiayaan_id');
    }
