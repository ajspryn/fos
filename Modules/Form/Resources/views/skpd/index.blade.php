    ...
    <section class="modern-horizontal-wizard">
        <div class="bs-stepper wizard-modern modern-wizard-example">
            <div class="bs-stepper-header">
                <div class="step" data-target="#form" role="tab" id="skpd-step-1">
                    ...
                    <div class="step" data-target="#form1" role="tab" id="skpd-step-2">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                    ...
                    <div class="step" data-target="#formupload" role="tab" id="skpd-step-3">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                ...
                <div class="step" data-target="#formorangterdekat" role="tab" id="skpd-step-4">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                                ...
                                <span class="bs-stepper-label">
                                    ...
                                    <span class="bs-stepper-subtitle">Masukan data Orang terdekat</span>
                                </span>
                            </button>
                        </div>
                        <div class="line">
                    ...
                    <div class="step" data-target="#formpekerjaan" role="tab" id="skpd-step-5">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                    ...
                    <div class="step" data-target="#formjaminan" role="tab" id="skpd-step-6">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                    ...
                    <div class="step" data-target="#form2" role="tab" id="skpd-step-7">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
                ...
                <div class="step" data-target="#formpengeluaran" role="tab" id="skpd-step-8">
                            <button type="button" class="step-trigger">
                                <span class="bs-stepper-box">
            ...
            <div class="bs-stepper-content">
                <form method="POST" action="/skpd/pembiayaan" id="formSkpd" class="needs-validation"
                    enctype="multipart/form-data" novalidate>
                    @csrf
                    <div id="form" class="content" role="tabpanel" aria-labelledby="skpd-step-1">
                    ...
                    <div id="form1" class="content" role="tabpanel" aria-labelledby="skpd-step-2">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="formupload" class="content" role="tabpanel" aria-labelledby="skpd-step-3">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="formorangterdekat" class="content" role="tabpanel" aria-labelledby="skpd-step-4">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="formpekerjaan" class="content" role="tabpanel" aria-labelledby="skpd-step-5">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="formjaminan" class="content" role="tabpanel" aria-labelledby="skpd-step-6">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="form2" class="content" role="tabpanel" aria-labelledby="skpd-step-7">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
                    ...
                    <div id="formpengeluaran" class="content" role="tabpanel" aria-labelledby="skpd-step-8">
                                <div class="content-header">
                                    {{-- <h5 class="mb-0">Account Details</h5> --}}
                                    <small class="text-danger">* Wajib Diisi</small>
                                </div>
