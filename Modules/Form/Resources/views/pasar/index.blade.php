                        ...
                        <form action="/form/pasar" method="post" enctype="multipart/form-data">
                            ...
                            <div id="form1" class="content" role="tabpanel" aria-labelledby="account-details-trigger">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="legalitas_kepemilikan_rumah" id="leg_rumah" required>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" name="no_tlp" id="no_tlp" class="form-control" placeholder="Masukan Nomor telepon Anda" required/>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="foto"><small class="text-danger">* </small>Upload Foto Diri</label>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="fotodiri"><small class="text-danger">* </small>Upload Foto KTP</label>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="fotodiri"><small class="text-danger">* </small>Upload Foto Diri Bersama KTP</label>
                                ...
                                <div class="row">
                                <div class="mb-1 col-md-6">
                                        <label class="form-label" for="nama_usaha"><small class="text-danger">* </small>Nama Kios / Los</label>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="keptoko"><small class="text-danger">* </small>Kepemilikan Kios / Los</label>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="blok" id="blok" class="form-control" placeholder="Masukan No / Blok Lama" >
                                    </div>
                                    <div class="mb-1 col-md-6">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="fototoko"><small class="text-danger">* </small>Upload Foto Kios / Los</label>
                            ...
                            <div id="form2" class="content" role="tabpanel" aria-labelledby="personal-info-modern-trigger">
                                ...
                                <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control numeral-mask" placeholder="Rp." name ="cicilanbtb" id="cicilanbtb" >
                                    </div>
                                </br>
                                                            ...
                                                            <div class="row d-flex align-items-end">
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="number" class="form-control numeral-mask" name="plafond" id="plafond" aria-describedby="itemcost" placeholder="Rp."/>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="number" class="form-control numeral-mask" name="outstanding" id="outstanding" aria-describedby="itemquantity" placeholder="Rp."/>
                                                                    </div>
                                                                </div>
                                ...
                                <div class ="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="aset" id="aset" class="form-control" placeholder="Masukan Kepemilikkan Aset" >
                                   </div>
                                    <div class="mb-1 col-md-6">
