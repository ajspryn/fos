                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="legalitas_kepemilikan_rumah"
                                            ...
                                            <option label="legalitas_kepemilikan_rumah">Pilih Legalitas Kepemilikan Rumah
                                            </option>
                            ...
                            <div id="form5" class="content" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="jenispasar_id" id="jenispasar_id" required>
                                            <option label="jenispasar_id">Pilih Jenis Pasar</option>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="blok" id="blok" class="form-control"
                                            placeholder="Masukan No / Blok Lama" required>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="hpp" id="hpp" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small
                                                class="text-danger">*</small>Biaya Listrik</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="listrik" id="listrik">
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small
