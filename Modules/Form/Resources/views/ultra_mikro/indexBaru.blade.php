...
@section('content')
                    ...
                    <div class="bs-stepper-content">
                        <form method="POST" action="/form/ultra_mikro" id="formUltraMikro" class="needs-validation"
                            ...
                            <div id="form" class="content" role="tabpanel" aria-labelledby="account-details-trigger">
                                ...
                                <div class="content-header">
                                    <h5 class="mb-0 mt-2">Pengajuan Pembiayaan Ultra Mikro Baru</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="margin"><small class="text-danger">*
                                            </small>Margin (%) per Bulan</label>
                                        <input type="number" name="rate" class="form-control"
                                            placeholder="Masukkan Persentase Margin (%) per Bulan" id="margin"
                                            required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                ...
                                <hr />
                                <div class="content-header">
                                    <h5 class="mb-0 mt-2">Pekerjaan</h5>
                                    <small class="text-muted">Lengkapi Data Pekerjaan.</small>
                                </div>
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="jenisPekerjaan"><small class="text-danger">*
                                            </small>Jenis Pekerjaan/Usaha</label>
                                        <input type="text" name="jenis_pekerjaan" id="jenisPekerjaan"
                                            class="form-control" placeholder="Masukkan Jenis Pekerjaan/Usaha"
                                            oninput="this.value=this.value.toUpperCase().replace(/[^A-Z, ]/g,'');"
                                            required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="tempatPekerjaan"><small class="text-danger">*
                                            </small>Tempat Pekerjaan/Usaha</label>
                                        <input type="text" name="tempat_pekerjaan" id="tempatPekerjaan"
                                            class="form-control" placeholder="Masukkan Tempat Pekerjaan/Usaha"
                                            oninput="this.value=this.value.toUpperCase().replace(/[^A-Z, ]/g,'');"
                                            required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="lamaPekerjaan"><small class="text-danger">*
                                            </small>Lama Pekerjaan/Usaha (Tahun)</label>
                                        <input type="number" name="lama_pekerjaan" id="lamaPekerjaan"
                                            class="form-control" placeholder="Masukkan Lama Pekerjaan/Usaha (Tahun)"
                                            required />
                                    </div>
                                ...
                                <hr />
                                <div class="content-header">
                                    <h5 class="mb-0 mt-2">Keuangan</h5>
                                    <small class="text-muted">Lengkapi Data Keuangan Per Bulan.</small>
                                </div>
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="omset"><small class="text-danger">*
                                            </small>a. Omset</label>
                                        <input type="text" name="omset" class="form-control numeral-mask"
                                            placeholder="Masukkan Omset" id="omset"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="belanjaUsaha"><small class="text-danger">*
                                            </small>b. Belanja Usaha</label>
                                        <input type="text" name="belanja_usaha" class="form-control numeral-mask"
                                            placeholder="Masukkan Belanja Usaha" id="belanjaUsaha"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>

                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="penghasilanKotor"><small class="text-danger">*
                                            </small>c. Penghasilan Kotor [a-b]</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Penghasilan Kotor" id="penghasilanKotorDummy" disabled />
                                        <input type="hidden" name="penghasilan_kotor" id="penghasilanKotor" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="gpm"><small class="text-danger">*
                                            </small>d. GPM [c/a]</label>
                                        <input type="text" class="form-control" placeholder="GPM" id="gpmDummy"
                                            disabled />
                                        <input type="hidden" name="gpm" id="gpm" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="pengeluaranUsaha"><small class="text-danger">*
                                            </small>e. Pengeluaran Usaha (BBM, air, listrik, dll)</label>
                                        <input type="text" name="pengeluaran_usaha" class="form-control numeral-mask"
                                            placeholder="Masukkan Pengeluaran Usaha" id="pengeluaranUsaha"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="penghasilanLain"><small class="text-danger">*
                                            </small>f. Penghasilan Lain (Penghasilan pasangan dll)</label>
                                        <input type="text" name="penghasilan_lain" class="form-control numeral-mask"
                                            placeholder="Masukkan Penghasilan Lain" id="penghasilanLain"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="penghasilanBersih"><small class="text-danger">*
                                            </small>g. Total Penghasilan Bersih [c-e]</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Total Penghasilan Bersih" id="penghasilanBersihDummy" disabled />
                                        <input type="hidden" name="penghasilan" id="penghasilanBersih"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="pengeluaranPerBulan"><small class="text-danger">*
                                            </small>h. Pengeluaran Rumah Tangga</label>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="belanja"><small class="text-danger">*
                                            </small>Belanja</label>
                                        <input type="text" name="belanja" class="form-control numeral-mask"
                                            placeholder="Pengeluaran Belanja" id="belanja"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="listrik"><small class="text-danger">*
                                            </small>Listrik</label>
                                        <input type="text" name="listrik" class="form-control numeral-mask"
                                            placeholder="Pengeluaran Listrik" id="listrik"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="air"><small class="text-danger">*
                                            </small>Air</label>
                                        <input type="text" name="air" class="form-control numeral-mask"
                                            placeholder="Pengeluaran Air" id="air"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="telepon"><small class="text-danger">*
                                            </small>Telepon</label>
                                        <input type="text" name="telepon" class="form-control numeral-mask"
                                            placeholder="Pengeluaran Telepon" id="telepon"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="pendidikan"><small class="text-danger">*
                                            </small>Pendidikan</label>
                                        <input type="text" name="pendidikan" class="form-control numeral-mask"
                                            placeholder="Pengeluaran Pendidikan" id="pendidikan"
                                            onkeyup="sumKeuangan(this.value);" required />
                                    </div>
                                    <div class="mb-1 col-md-2">
                                        <label class="form-label" for="totalPengeluaranRumahTangga"><small
                                                class="text-danger">*
                                            </small>Total</label>
                                        <input type="text" class="form-control numeral-mask" placeholder="Total"
                                            id="totalPengeluaranRumahTanggaDummy" disabled />
                                        <input type="hidden" name="total_pengeluaran_rumah_tangga"
                                            id="totalPengeluaranRumahTangga" required />

                                    </div>

                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="sisaPenghasilan"><small class="text-danger">*
                                            </small>i. Sisa Penghasilan [f+g-h]</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Masukkan Sisa Penghasilan" id="sisaPenghasilanDummy" disabled />
                                        <input type="hidden" name="sisa_penghasilan" id="sisaPenghasilan" required />
                                    </div>
    ...
    <script>
        ...
        function sumKeuangan(value) {
            var omset, belanjaUsaha, penghasilanKotor, penghasilanKotorDummy,
                gpm, gpmDummy,
                pengeluaranUsaha,
                penghasilanLain,
                penghasilanBersih, penghasilanBersihDummy,
                belanja, listrik, air, telepon, pendidikan, totalPengeluaranRumahTangga,
                totalPengeluaranRumahTanggaDummy, sisaPenghasilan, sisaPenghasilanDummy;

            omset = parseFloat(document.getElementById("omset").value.replace(/\./g, "").replace(/,/g, '.')) || 0;
            belanjaUsaha = parseFloat(document.getElementById("belanjaUsaha").value.replace(/\./g, "").replace(/,/g,
                '.')) || 0;
            pengeluaranUsaha = parseFloat(document.getElementById("pengeluaranUsaha").value.replace(/\./g, "").replace(/,/g,
                '.')) || 0;
            penghasilanLain = parseFloat(document.getElementById("penghasilanLain").value.replace(/\./g, "").replace(/,/g,
                '.')) || 0;
            belanja = parseFloat(document.getElementById("belanja").value.replace(/\./g, "").replace(/,/g, '.')) || 0;
            listrik = parseFloat(document.getElementById("listrik").value.replace(/\./g, "").replace(/,/g, '.')) || 0;
            air = parseFloat(document.getElementById("air").value.replace(/\./g, "").replace(/,/g, '.')) || 0;
            telepon = parseFloat(document.getElementById("telepon").value.replace(/\./g, "").replace(/,/g, '.')) || 0;
            pendidikan = parseFloat(document.getElementById("pendidikan").value.replace(/\./g, "").replace(/,/g, '.')) || 0;


            //Penghasilan Kotor
            penghasilanKotor = +omset - +belanjaUsaha;
            document.getElementById("penghasilanKotor").value = penghasilanKotor;

            penghasilanKotorDummy = penghasilanKotor.toLocaleString('id-ID');
            document.getElementById("penghasilanKotorDummy").value = penghasilanKotorDummy;

            //GPM
            gpm = +penghasilanKotor / +omset * 100;
            document.getElementById("gpm").value = gpm;

            gpmDummy = gpm.toLocaleString('id-ID');
            document.getElementById("gpmDummy").value = gpmDummy;

            //Penghasilan Bersih
            penghasilanBersih = +penghasilanKotor - +pengeluaranUsaha;
            document.getElementById("penghasilanBersih").value = penghasilanBersih;

            penghasilanBersihDummy = penghasilanBersih.toLocaleString('id-ID');
            document.getElementById("penghasilanBersihDummy").value = penghasilanBersihDummy;

            //Pengeluaran Rumah Tangga
            totalPengeluaranRumahTangga = +belanja + +listrik + +air + +telepon + +pendidikan;
            document.getElementById("totalPengeluaranRumahTangga").value = totalPengeluaranRumahTangga;

            totalPengeluaranRumahTanggaDummy = totalPengeluaranRumahTangga.toLocaleString('id-ID');
            document.getElementById("totalPengeluaranRumahTanggaDummy").value = totalPengeluaranRumahTanggaDummy;

            //Sisa Penghasilan
            sisaPenghasilan = +penghasilanLain + +penghasilanBersih - +totalPengeluaranRumahTangga;
            document.getElementById("sisaPenghasilan").value = sisaPenghasilan;

            sisaPenghasilanDummy = sisaPenghasilan.toLocaleString('id-ID');
            document.getElementById("sisaPenghasilanDummy").value = sisaPenghasilanDummy;
        }
    </script>
@endsection
