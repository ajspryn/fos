            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        <form method="POST" action="/form/p3k/{{ $pembiayaan->id }}" id="formP3k"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="jenis_penggunaan" id="jenispenggunaan"
                                            ...
                                            <option value="Ibadah Haji">Ibadah Haji</option>
                                        </select>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" name="no_ktp" id="noktp" class="form-control"
                                            placeholder="Masukkan Nomor KTP" value="{{ $pembiayaan->nasabah->no_ktp }}"
                                            required />
                                    </div>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="agama" id="agama"
                                            ...
                                            <option value="Katholik"
                                                {{ $pembiayaan->nasabah->agama == 'Katholik' ? 'selected' : '' }}>Katholik
                                            </option>
                                            <option value="Budha"
                                            ...
                                            <option value="Kong Hu Chu"
                                                {{ $pembiayaan->nasabah->agama == 'Kong Hu Chu' ? 'selected' : '' }}>Kong
                                                Hu Chu</option>
                                        </select>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                                            ...
                                                            <div class="col-md-2 col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        oninput="this.value=this.value.toUpperCase().replace(/[^A-Z, ]/g,'');"
                                                                        placeholder="Kecamatan"
                                                                        value="{{ $pembiayaan->nasabah->kecamatan_domisili }}"required />
                                                                </div>
                                                            </div>
