            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        <form class="needs-validation" action="/form/umkm" method="post" enctype="multipart/form-data"
                            novalidate>
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="akad" id="akad"
                                            data-placeholder="Jenis Akad" disabled>
                                            <option value=""></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="status_id" id="status_id"
                                            ...
                                            @foreach ($statuss as $status)
                                                <option value="{{ $status->id }}">{{ $status->nama_status_perkawinan }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="jumlah_anak" id="jumlah_anak"
                                            data-placeholder="Pilih Jumlah Anak" required>
                                            <option value=""></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="leg_toko_id" id="legalitastoko"
                                            data-placeholder="Pilih Legalitas Kepemilikan Usaha" required>
                                            <option value=""></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Isi
                                            0 Jika Tidak Ada" name="hpp" id="hpp" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Biaya Listrik</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="listrik" id="listrik" required>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Biaya Transport</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="trasport" id="transport" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Biaya Karyawan</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="karyawan" id="karyawan" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Biaya Telepon</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="telpon" id="telpon" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Biaya Sewa
                                            Kios</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="sewa" id="sewa" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                            ...
                            <div id="form8" class="content" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="keb_keluarga" id="kebkeluarga"
                                            required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
