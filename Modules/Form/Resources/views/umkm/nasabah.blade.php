            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        <form class="needs-validation" action="/form/umkm/{{ $pembiayaan->id }}" method="post"
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="tgl_pembiayaan" id="tgl_pembiayaan"
                                            class="form-control flatpickr-basic" name="tanggal" placeholder="DD-MM-YYYY"
                                            required>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="lama_tinggal" id="lama_tinggal" required>
                                            <option value="{{ $pembiayaan->nasabahh->lama_tinggal }}"
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="kepemilikan_rumah" id="kep_rumah"
                                            data-placeholder="Pilih Kepemilikan Rumah" required>
                                            <option value=""></option>
                                            <option
                                            ...
                                            <option
                                                ...
                                                value="Sewa Atau Kontrak">Sewa Atau Kontrak</option>
                                        </select>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="legalitas_kepemilikan_rumah" id="leg_rumah"
                                            data-placeholder="Pilih Legalitas Kepemilikan Rumah" required>
                                            <option value=""></option>
                                            @foreach ($rumahs as $rumah)
                                                <option value="{{ $rumah->kode_jaminan }}"
                                                    {{ $pembiayaan->rumah->legalitasrumah->nama_jaminan == $rumah->nama_jaminan ? 'selected' : '' }}>
                                                    {{ $rumah->nama_jaminan }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="pendidikan" id="pendidikan_id" required>
                                            ...
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'SD' ? 'selected' : '' }}
                                                value="SD">SD</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'SMP' ? 'selected' : '' }}
                                                value="SMP">SMP</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'SMA' ? 'selected' : '' }}
                                                value="SMA">SMA</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'Diploma' ? 'selected' : '' }}
                                                value="Diploma">Diploma</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'S1' ? 'selected' : '' }}
                                                value="S1">S1</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'S2' ? 'selected' : '' }}
                                                value="S2">S2</option>
                                            <option {{ $pembiayaan->nasabahh->pendidikan == 'S3' ? 'selected' : '' }}
                                                value="S3">S3</option>
                                        </select>
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="agama_id" id="agama_id" required>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Islam' ? 'selected' : '' }}
                                                value="Islam">Islam</option>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Kristen' ? 'selected' : '' }}
                                                value="Kristen">Kristen</option>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Katholik' ? 'selected' : '' }}
                                                value="Katholik">Katholik</option>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Hindu' ? 'selected' : '' }}
                                                value="Hindu">Hindu</option>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Buddha' ? 'selected' : '' }}
                                                value="Buddha">Buddha</option>
                                            <option {{ $pembiayaan->nasabahh->agama_id == 'Konghucu' ? 'selected' : '' }}
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="jaminanlain" id="jaminanlain"
                                            data-placeholder="Pilih Jaminan" required>
                                            <option value=""></option>
                            ...
                            <div id="form7" class="content" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="pendapatanLain"><small class="text-danger">*
                                            </small>Pendapatan Lain</label>
                                        <input type="text" class="form-control numeral-mask"
                                            placeholder="Isi 0 Jika Tidak Ada" name="pendapatan_lain" id="pendapatanLain"
                                            required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="ketPendapatanLain"><small class="text-danger">*
                                            </small>Keterangan Pendapatan Lain</label>
                                        <input type="text" class="form-control" placeholder="Isi - Jika Tidak Ada"
                                            name="ket_pendapatan_lain" id="ketPendapatanLain" required />
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between mt-3">
                                    <a class="btn btn-outline-secondary btn-prev">
                            ...
                            <div id="form8" class="content" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Pengeluaran Lainnya</label>
                                        <input type="text" class="form-control numeral-mask" placeholder="Rp."
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Keterangan Pengeluaran Lainnya</label>
                                    ...
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="numeral-formatting"><small class="text-danger">*
                                            </small>Kesanggupan Angsuran</label>
                                        <input type="text" class="form-control numeral-mask"
