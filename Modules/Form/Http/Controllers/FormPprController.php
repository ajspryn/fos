...
class FormPprController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        FormPprDataPribadi::create([
            ...
            'form_pribadi_pemohon_no_ktp_berlaku_sd' => request('form_pribadi_pemohon_no_ktp_berlaku_sd'),
            ...
            'form_pribadi_istri_suami_no_ktp_berlaku_sd' => request('form_pribadi_istri_suami_no_ktp_berlaku_sd'),
