                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                        ...
                                                                        <div class="card-body">
                                                                            @foreach ($deviasiItems as $devItem)
                                                                                <h4 class="text-center">Deviasi {{ optional($devItem)->kategori_deviasi ?? '' }}</h4>
                                                                                @if (optional($devItem)->dokumen_deviasi)
                                                                                    <iframe
                                                                                        src="{{ asset('storage/' . optional($devItem)->dokumen_deviasi) }}"
