                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    @foreach ($komites as $komite)
                                        ...
                                        @if ($history->jabatan_id == 4 || ($history->jabatan_id == 3 && $history->status_id == 5) || ($history->jabatan_id == 1 && $history->status_id >= 9))
                                            <tr>
                                                <td class="midCenter">{{ $loop->iteration }}</td>
                                                <td class="midCenter d-none d-md-table-cell">{{ date_format($proposal_ppr->created_at, 'd-m-Y') }}</td>
                                                ...
                                                <td class="midCenter">
                                                    <a href="/dirbis/ppr/komite/{{ $proposal_ppr->id }}" class="btn btn-outline-info btn-sm round">Detail</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
