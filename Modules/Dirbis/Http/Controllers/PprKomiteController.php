...
class PprKomiteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->status_id == 5) {
            return redirect('/dirbis/ppr/komite/')->with('success', 'Proposal Berhasil Disetujui!');
            ...
            return redirect('/dirbis/ppr/komite/')->with('success', 'Proposal Diajukan Untuk Revisi!');
        } else {
        }
    }
    ...
    public function show($id)
    {
        ...
        if ($cek && $cek->status_id == 5 && $cek->jabatan_id == 3) {
            PprPembiayaanHistory::create([
