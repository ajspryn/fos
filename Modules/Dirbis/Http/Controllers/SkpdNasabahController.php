...
class SkpdNasabahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dirbis::skpd.nasabah.index', [
            'title' => 'Data Nasabah',
            'proposals' => SkpdNasabah::select()->when($search, fn($q) => $q->where('nama_nasabah', 'like', "%{$search}%"))->paginate(10)->withQueryString(),
    ...
    public function show($id)
    {
        ...
        return view('dirbis::skpd.nasabah.lihat', [
            'title' => 'Nasabah',
