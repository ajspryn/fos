                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            ...
                            <div class="user-info text-center">
                                <h4>{{ $pembiayaan->nasabah->nama_nasabah }}</h4>
                                <span class="badge bg-light-secondary">{{ $pembiayaan->nasabah->no_ktp }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-around my-2 pt-75">
                        <div class="d-flex align-items-start me-2">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">{{ $pembiayaan->nasabah->no_telp }}</h5>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">{{ $pembiayaan->nasabah->alamat }}, Rt
                                    {{ $pembiayaan->nasabah->rt }}/{{ $pembiayaan->nasabah->rw }}</h4>
                                    <small>{{ $pembiayaan->nasabah->desa_kelurahan }} ,
                                        {{ $pembiayaan->nasabah->kecamatan }}</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-start me-2">
                            <span class="badge bg-light-primary p-75 rounded">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-75">
                                        ...
                                        <span> {{ $pembiayaan->nasabah->tempat_lahir }} /
                                            {{ $pembiayaan->nasabah->tgl_lahir }}</span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">Status Perkawinan :</span>
                                        <span value="{{ $pembiayaan->nasabah->status_perkawinan->id }}">
