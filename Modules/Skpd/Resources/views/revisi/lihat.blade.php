                                ...
                                <div id="form1" class="content" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="hidden" name="foto[5][foto_lama]"
                                                    value="{{ old('foto', $fotostatus->foto) }}">
                                                <input type="hidden" name="foto[5][id]" rows="3"
                                                    class="form-control" value="{{ $fotostatus->id }}">
                                                <input type="file" name="foto[5][foto]" id="fotokk" rows="3"
                                                    class="form-control" required />
                                                <input type="hidden" name="foto[5][kategori]"
                                                    value="Akta Status Pekawinan" rows="3" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="content-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-4">
                                                ...
                                                <input type="text" name="desa_kelurahan_orang_terdekat"
                                                    id="desa_kelurahan" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label" for="skpengangkatan"><small
                                                        class="text-danger">*
                                                    </small>Upload Softcopy SK Pengangkatan / SK Terakhir</label>
                                                <input type="file" name="sk_pengangkatan" id="skpengangkatan"
                                                    rows="3" class="form-control" />
                                                <input type="hidden" name="sk_pengangkatan_lama"
                                                    value="{{ $pembiayaan->sk_pengangkatan }}" rows="3"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="content-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label" for="jaminan_dokumen"><small
                                                        class="text-danger">*
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label" for="jaminan_lainnya">Upload Jaminan
                                                    Lainnya</label>
                                    ...
                                    <div id="form2" class="content" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label" for="pendapatan_tpp"><small
                                                        class="text-danger">*
                                                    </small>Pendapatan TPP (Per Bulan)</label>
                                                <input type="text" name="gaji_tpp" class="form-control numeral-mask3"
                                                    value="{{ number_format($pembiayaan->gaji_tpp) }}"
                                                    id="pendapatan_tpp" required />
                                            </div>
                                            <div class="mb-1 col-md-6">
                                        ...
                                        <div class="table-responsive">
                                            <small>Data Informasi Debitur Nasabah</small>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                        ...
                                        <div class="table-responsive">
                                            <small>Data Informasi Debitur Pasangan Nasabah</small>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align: center; width: 5%;" class="py-1">No</th>
