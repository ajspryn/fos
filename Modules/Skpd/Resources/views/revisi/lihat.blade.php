                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-12">
                                        ...
                                        <select class="select2 w-100" name="user_id" id="ao" required>
                                            @foreach ($aos as $ao)
                                            @if (old('user_id' , $ao->user->id) == $ao->user->name)
                                            <option value="{{ $ao->user->id }}" selected>{{ $ao->user->name }}</option>
                                            @else
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" id="tanggal" class="form-control flatpickr-basic"
                                            name="tanggal_pengajuan" placeholder="YYYY-MM-DD" value="{{ $pembiayaan->tanggal_pengajuan }}" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="skpd_jenis_penggunaan_id"
                                            ...
                                            <option value="{{ $penggunaan->id }}" selected>{{ $penggunaan->jenis_penggunaan }}</option>
                                            @else
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="skpd_sektor_ekonomi_id" id="sektor" required>
                                            ...
                                            <option value="{{ $sektor->id }}" selected>{{ $sektor->nama_sektor_ekonomi }}
                                            </option>
                                            @else
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <select class="select2 w-100" name="skpd_akad_id" id="akad" required>
                                            ...
                                            <option value="{{ $akad->id }}" selected>{{ $akad->nama_akad }}</option>
                                            @else
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="nominal_pembiayaan"
                                            ...
                                            required value="{{ $pembiayaan->nominal_pembiayaan }}"/>
                                    </div>
                                    <div class="mb-1 col-md-4">
                                        ...
                                        <select class="select2 w-100" name="tenor" id="tenor" required>
                                            ...
                                            <option value={{ $pembiayaan->tenor }} selected>{{ $pembiayaan->tenor }} Bulan</option>
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" name="nama_nasabah" id="nama" class="form-control"
                                            placeholder="Nama Lengkap" value="{{ $nasabah->nama_nasabah }}" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" name="no_ktp" id="noktp" class="form-control"
                                            placeholder="Masukan Nomor KTP Anda" value="{{ $nasabah->no_ktp }}" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="nama">Nama Lengkap Pasangan Nasabah</label>
                                        <input type="text" name="nama_pasangan_nasabah" id="nama" class="form-control" value="{{ $nasabah->nama_pasangan_nasabah }}"
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" name="no_ktp_pasangan" id="noktp" class="form-control"
                                            placeholder="Masukan Nomor KTP pasangan Anda" value="{{ $nasabah->no_ktp_pasangan }}" />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="tempatlahir"><small class="text-danger">*
                                            </small>Tempat Lahir</label>
                                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
                                            placeholder="Maukan Tempat Lahir Anda" value="{{ $nasabah->tempat_lahir }}" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="date" id="tgl_lahir" class="form-control flatpickr-basic"
                                            name="tgl_lahir" placeholder="YYYY-MM-DD" value="{{ $nasabah->tgl_lahir }}" required />
                                    </div>
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="exampleFormControlTextarea1"><small
                                                class="text-danger">* </small>Alamat Sesuai KTP</label>
                                        <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Alamat" value="{{ $nasabah->alamat }}"
                                            required></textarea>
                                    </div>
