                        ...
                        <table class="datatables-basic table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $proposal->nasabah->alamat }}, {{ $proposal->nasabah->rt }}, {{ $proposal->nasabah->rw }}, {{ $proposal->nasabah->desa_kelurahan }}, {{ $proposal->nasabah->kecamatan }}, {{ $proposal->nasabah->kabkota }}, {{ $proposal->nasabah->provinsi }}</td>
                                    ...
                                    <td style="text-align: center">
                                        <a href="/skpd/proposal/{{ $proposal->id }}" class="btn btn-outline-info round">Lengkapi</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
