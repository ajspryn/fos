...
class PasarJenisDagangController extends Controller
{
    /**
    ...
    {
        return view('admin::pasar.Jenis_Dagang.index',[
            'title'=>'Pengaturan Jenis Dagang Pasar',
