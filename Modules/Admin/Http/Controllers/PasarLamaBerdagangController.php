...
class PasarLamaBerdagangController extends Controller
{
    /**
    ...
    {
        return view('admin::pasar.lamadagang.index',[
            'title'=>'Pengaturan Lama Berdagang Pasar',
    ...
    public function store(Request $request)
    {
        ...
        PasarLamaBerdagang::create($input);
