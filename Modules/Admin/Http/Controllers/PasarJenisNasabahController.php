...
class PasarJenisNasabahController extends Controller
{
    /**
    ...
    {
        return view('admin::pasar.jenisnasabah.index',[
            'title'=>'Pengaturan Jenis Nasabah Pasar',
    ...
    public function store(Request $request)
    {
        ...
        PasarJenisNasabah::create($input);
