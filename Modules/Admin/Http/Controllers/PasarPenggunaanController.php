...
class PasarPenggunaanController extends Controller
{
     ...
     {
          return view('admin::pasar.penggunaan.index', [
               'title' => 'Pengaturan Penggunaan Pasar',
     ...
     public function store(Request $request)
     {
          ...
          $input = $request->all();
          PasarPenggunaan::create($input);

          return redirect()->back()->with('success', 'Data Penggunaan Berhasil Ditambahkan');
     }
