            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pengaturan Cash Pick Up</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Cash Pick Up</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Cash Pick Up</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Cash Pick Up" name="kode_jeniscash"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Cash Pick Up</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Cash Pick Up" name="nama_jeniscash"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
