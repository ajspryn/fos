                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Status Perkawinan" name="kode_status_perkawinan"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Status Perkawinan</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Status Perkawinan" name="nama_status_perkawinan"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Biaya</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Biaya" name="biaya"/>
                                                </div>
                                            </div>
                                            <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                        @foreach ($statusperkawinans as $status )
                                        <tr>
                                            <td style="text-align: center">{{ $loop->iteration }}</td>
                                            <td style="text-align: center">{{ $status->kode_status_perkawinan }}</td>
                                            <td style="text-align: center">{{ $status->nama_status_perkawinan }}</td>
                                            <td>{{ $status->biaya }}</td>
