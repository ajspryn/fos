            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pengaturan Jenis Nasabah</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Jenis Nasabah</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Jenis Nasabah</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Jenis Nasabah" name="kode_jenisnasabah"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Jenis Nasabah</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Jenis Nasabah" name="nama_jenisnasabah"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $nasabah->kode_jenisnasabah }}</td>
                                            <td>{{ $nasabah->nama_jenisnasabah }}</td>
                                            <td>{{ $nasabah->rating }}</td>
                                            <td>{{ $nasabah->bobot}}</td>
                                            <td></td>
                                        </tr>
                                        @endforeach
