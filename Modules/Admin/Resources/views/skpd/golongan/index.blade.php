            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pengaturan Golongan</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Golongan</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form" method="post" action="/admin/skpd/golongan">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Kode Golongan</label>
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Golongan" name="kode_golongan" value="{{ old('kode_golongan') }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Golongan</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Golongan" name="nama_golongan" value="{{ old('nama_golongan') }}" />
                                                </div>
                                            </div>
                                            <div class="col-12">
