                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Tanggungan" name="kode_tanggungan" value="{{ old('kode_tanggungan') }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Banyak Tanggungan</label>
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Banyak Tanggungan" name="banyak_tanggungan" value="{{ old('banyak_tanggungan') }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Biaya</label>
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Biaya" name="biaya" value="{{ old('biaya') }}" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            @forelse ($tanggungans as $tanggungan)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        ...
                                                        <form action="/admin/skpd/tanggungan/{{ $tanggungan->id }}" method="POST" class="d-inline" 
...
<div class="modal fade" id="editModal-{{ $tanggungan->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/admin/skpd/tanggungan/{{ $tanggungan->id }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="banyak_tanggungan" class="form-control" value="{{ $tanggungan->banyak_tanggungan }}" required>
                    </div>
                    <div class="mb-3">
