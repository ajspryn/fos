            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pengaturan Jaminan Usaha</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="/umkm/komite/{{ $proposal->id }}">Jaminan</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="text-align: center"></th>
                                                <th>No</th>
                                            <th>Kode</th>
                                            <th class="d-none d-md-table-cell">Jaminan</th>
                                            <th>Rating</th>
                                            <th>Bobot</th>
