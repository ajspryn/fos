                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="/umkm/komite/{{ $proposal->id }}">Jenis Dagang</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Isikan Kode Jenis Dagang" name="kode_golongan"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="first-name-column">Jenis Dagang</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Isikan Jenis Dagang" name="nama_golongan"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="text-align: center"></th>
                                                <th>No</th>
                                            <th>Kode</th>
                                            <th class="d-none d-md-table-cell">Jenis Dagang</th>
