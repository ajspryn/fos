...
<head>
    ...
    <title>{{ $title }}</title>
    <link rel="apple-touch-icon" href="{{ url('') }}/faviconBTB.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('') }}/faviconBTB.png">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('') }}/app-assets/css/plugins/charts/chart-apex.min.css">
    <!-- END: Page CSS-->
