                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capacity Fixed Income Usia</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($capacity_usias as $capacity_usia)
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $capacity_usia->kode }}
                                                </td>
                                                <td>{{ $capacity_usia->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_usia->rating }}</td>
                                                <td style="text-align: center">{{ $capacity_usia->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
