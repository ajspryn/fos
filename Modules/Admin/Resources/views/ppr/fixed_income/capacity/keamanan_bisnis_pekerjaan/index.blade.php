                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capacity Fixed Income Keamanan Bisnis/Pekerjaan</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($capacity_keamanan_bisnis_pekerjaans as $capacity_keamanan_bisnis_pekerjaan)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    {{ $capacity_keamanan_bisnis_pekerjaan->kode }}
                                                </td>
                                                <td>{{ $capacity_keamanan_bisnis_pekerjaan->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_keamanan_bisnis_pekerjaan->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_keamanan_bisnis_pekerjaan->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
