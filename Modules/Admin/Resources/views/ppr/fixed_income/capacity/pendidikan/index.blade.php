                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capacity Fixed Income Pendidikan</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($capacity_pendidikans as $capacity_pendidikan)
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $capacity_pendidikan->kode }}
                                                </td>
                                                <td>{{ $capacity_pendidikan->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_pendidikan->rating }}</td>
                                                <td style="text-align: center">{{ $capacity_pendidikan->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
