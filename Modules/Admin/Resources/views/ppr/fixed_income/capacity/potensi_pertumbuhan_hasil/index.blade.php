                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capacity Fixed Income Potensi Pertumbuhan Hasil</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($capacity_potensi_pertumbuhan_hasils as $capacity_potensi_pertumbuhan_hasil)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    {{ $capacity_potensi_pertumbuhan_hasil->kode }}
                                                </td>
                                                <td>{{ $capacity_potensi_pertumbuhan_hasil->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_potensi_pertumbuhan_hasil->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_potensi_pertumbuhan_hasil->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
