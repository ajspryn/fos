            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pengaturan Collateral Fixed Income Jangka Waktu
                                Likuidasi
                            </h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Collateral Fixed Income Jangka
                                            Waktu
                                            Likuidasi</a>
                                    </li>
                                </ol>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Collateral Fixed Income Jangka Waktu Likuidasi</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($collateral_jangka_waktu_likuidasis as $collateral_jangka_waktu_likuidasi)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    {{ $collateral_jangka_waktu_likuidasi->kode }}
                                                </td>
                                                <td>{{ $collateral_jangka_waktu_likuidasi->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $collateral_jangka_waktu_likuidasi->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $collateral_jangka_waktu_likuidasi->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
