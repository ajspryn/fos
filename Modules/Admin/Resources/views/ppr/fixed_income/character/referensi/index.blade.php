            ...
            <div class="content-body">
                ...
                <section id="multiple-column-form">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Form Character Fixed Income Referensi</h5>
                                <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @forelse ($character_referensis as $character_referensi)
                                            <tr>
                                                <td style="text-align: center">{{ $loop->iteration }}</td>
                                                <td style="text-align: center">{{ $character_referensi->kode }}</td>
                                                <td>{{ $character_referensi->keterangan }}</td>
                                                <td style="text-align: center">{{ $character_referensi->rating }}</td>
                                                <td style="text-align: center">{{ $character_referensi->bobot }}</td>
                                            </tr>
                                        @empty
                                            <tr>
