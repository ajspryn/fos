                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capital Fixed Income Keamanan Bisnis/Pekerjaan</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($capital_keamanan_bisnis_pekerjaans as $capital_keamanan_bisnis_pekerjaan)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    {{ $capital_keamanan_bisnis_pekerjaan->kode }}
                                                </td>
                                                <td>{{ $capital_keamanan_bisnis_pekerjaan->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capital_keamanan_bisnis_pekerjaan->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $capital_keamanan_bisnis_pekerjaan->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
