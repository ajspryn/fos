                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capital Fixed Income Potensi Pertumbuhan Hasil</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($capital_potensi_pertumbuhan_hasils as $capital_potensi_pertumbuhan_hasil)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    {{ $capital_potensi_pertumbuhan_hasil->kode }}
                                                </td>
                                                <td>{{ $capital_potensi_pertumbuhan_hasil->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capital_potensi_pertumbuhan_hasil->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $capital_potensi_pertumbuhan_hasil->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
