                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Capacity Non Fixed Income Kaderisasi</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($capacity_nf_kaderisasis as $capacity_nf_kaderisasi)
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $capacity_nf_kaderisasi->kode }}
                                                </td>
                                                <td>{{ $capacity_nf_kaderisasi->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $capacity_nf_kaderisasi->rating }}</td>
                                                <td style="text-align: center">{{ $capacity_nf_kaderisasi->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
