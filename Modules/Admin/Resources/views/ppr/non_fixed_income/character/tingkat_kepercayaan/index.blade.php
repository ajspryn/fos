                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Character Non Fixed Income Tingkat Kepercayaan</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($character_nf_tingkat_kepercayaans as $character_nf_tingkat_kepercayaan)
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $character_nf_tingkat_kepercayaan->kode }}
                                                </td>
                                                <td>{{ $character_nf_tingkat_kepercayaan->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $character_nf_tingkat_kepercayaan->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $character_nf_tingkat_kepercayaan->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
