                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Form Collateral Non Fixed Income Kontribusi Pemohon (FTV)</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($collateral_nf_kontribusi_pemohons as $collateral_nf_kontribusi_pemohon)
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ $collateral_nf_kontribusi_pemohon->kode }}
                                                </td>
                                                <td>{{ $collateral_nf_kontribusi_pemohon->keterangan }}</td>
                                                <td style="text-align: center">
                                                    {{ $collateral_nf_kontribusi_pemohon->rating }}</td>
                                                <td style="text-align: center">
                                                    {{ $collateral_nf_kontribusi_pemohon->bobot }}
                                                </td>
                                                <td style="text-align: center">
                                                    <div class="dropdown">
                                                        <button type="button"
