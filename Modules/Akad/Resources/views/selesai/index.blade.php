        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    @else
                                                        <a class="badge rounded-pill badge-light-danger"
                                                            data-bs-toggle="modal" data-bs-target="#modalCatatanAkadBatal">
                    ...
                    <div class="modal fade" id="modalCatatanAkadBatal" tabindex="-1" aria-labelledby="addNewCardTitle"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                    ...
                                    <br />
                                    <textarea class="form-control" name="catatan" rows="3" placeholder="Catatan Anda">{{ $akadBerhasil->catatan }}</textarea>
                                    <br />
                                    <div class="row">
