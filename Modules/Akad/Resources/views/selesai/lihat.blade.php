...
@section('content')
    <div class="app-content content ">
                ...
                <section id="nav-filled">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        @if ($segmen == 'PPR')
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Proposal Pembiayaan PPR</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="tab-content pt-1">
                                        <div class="tab-pane active show show" id="proposal" role="tabpanel"
                                                                            ...
                                                                            @if ($pembiayaan->jenis_nasabah == 'Fixed Income')
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: center">
                                                                                        ...
                                                                                        @elseif($scoring->scoringAtrFixedIncome->atr_fixed_score >= 1.4 && $scoring->scoringAtrFixedIncome->atr_fixed_score < 1.7)
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: center">
                                                                                        @if ($scoring->scoringWtrFixedIncome->wtr_fixed_score >= 0.9)
                                                                                            <strong>Risiko Rendah</strong>
                                                                                        @elseif($scoring->scoringWtrFixedIncome->wtr_fixed_score >= 0.75 && $scoring->scoringWtrFixedIncome->wtr_fixed_score < 0.9)
                                                                                            <strong>Risiko Sedang</strong>
                                                                                        @else
                                                                                            <strong>Risiko Tinggi</strong>
                                                                                        @endif
                        ...
                        @elseif ($segmen == 'Pasar')
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Proposal Pembiayaan Pasar</h4>
                                </div>
                                <div class="content-body">
                                    <section id="nav-filled">
        ...
        @elseif ($segmen == 'UMKM')
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Proposal Pembiayaan UMKM</h4>
                </div>
                <div class="card-body">
                    <div class="col-xl-12 col-md-8 col-12">
                        <div class="content-body">
        ...
        @elseif ($segmen == 'SKPD')
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Proposal Pembiayaan SKPD</h4>
                </div>
                <div class="card-body">
                    <div class="content-body">
                        <section id="nav-filled">
                                                                ...
                                                                <div class="row invoice-spacing">
                                                                    <div class="col-xl-8 p-0">
                                                                        <table>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="pe-1">Nama AO
                                                                                    </td>
                                                                                    <td>:<span class="fw-bold">
                                                                                            {{ strtoupper($pembiayaan->user->name) }}</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <table>
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>:
                                                                                                    @if ($nilai_dsr1 >= 40 || ($nilai_dsr1 < 0 && $total_score > 3.01))
                                                                                                        @if ($nilai_dsr1 >= 40 && $total_score > 3.01)
                                                                                                            <span
                                                                                                                class="badge rounded-pill badge-glow bg-success">Diterima</span>
                                                                                                            <small
                                                                                                                class="text-danger">
                                                                                                                *DSR
                                                                                                                >
                                                                                                                40%</small>
                                                                                                        @elseif($nilai_dsr1 < 0 && $total_score > 3.01)
                                                                                                            <span
                                                                                                                class="badge rounded-pill badge-glow bg-success">Diterima</span>
                                                                                                            <small
                                                                                                                class="text-danger">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body px-sm-12 mx-50 pb-5">
                                        ...
                                        <div class="card-body">
                                            @if ($konfirmasi)
                                                <iframe
                                                    src="https://view.officeapps.live.com/op/view.aspx?src={{ urlencode(asset('storage/' . $konfirmasi->foto)) }}"
    ...
    @elseif ($segmen == 'P3K')
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab-justified" data-bs-toggle="tab" href="#proposal"
                            role="tab" aria-controls="home-just" aria-selected="true">Proposal</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="settings-tab-justified" data-bs-toggle="tab" href="#keuangan"
                            role="tab" aria-controls="settings-just" aria-selected="false">Keuangan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="settings-tab-justified" data-bs-toggle="tab" href="#ideb"
                            role="tab" aria-controls="settings-just" aria-selected="false">IDEB</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="settings-tab-justified" data-bs-toggle="tab" href="#timeline"
                            role="tab" aria-controls="settings-just" aria-selected="false">Timeline</a>
                    </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content pt-1">
                                ...
                                <div class="card-body invoice-padding pt-0">
                                    <div class="row invoice-spacing">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:
                                                            ...
                                                            @php
                                                                ...
                                                                // Max usia pengajuan 56 Tahun = 672 Bulan
                                                                $sisaUsia = 672 - $usiaInMonth;
                                        ...
                                        <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>:
                                                            {{ strtoupper($pembiayaan->nasabah->pekerjaan->nama_unit_kerja) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Jabatan</td>
                                                        <td>:
                                                            {{ strtoupper($pembiayaan->nasabah->pekerjaan->jabatan) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="fw-bold">: Rp
                                                                {{ number_format($pembiayaan->gaji_pokok + $pembiayaan->gaji_tpp) }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <hr>
                                            <h6>Sisa Pendapatan Bersih : Rp
                                                {{ number_format($pendapatanBersih - $angsuran) }}
                                            </h6>
                                            <hr>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($idebPasangans as $idebPasangan)
                                                    <tr>
                                                        ...
                                                        <td>Rp.
                                                            {{ number_format($idebPasangan->plafond) }}
                                                        </td>
                                                        <td>Rp.
                                                            {{ number_format($idebPasangan->outstanding) }}
                                                        </td>
                                                        <td style="text-align: center">
                                                            {{ $idebPasangan->tenor }}
                                                        </td>
                                                        ...
                                                        <td>Rp.
                                                            {{ number_format($idebPasangan->angsuran) }}
                                                        </td>
                                                        <td style="text-align: center">
                                                            {{ $idebPasangan->agunan }}
                                                        </td>
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: {{ $akhirPembiayaan }} Tahun</td>
                                                    </tr>
                                                    @if ($tenor > $sisaUsia)
                                                        <tr>
                                                            <td class="pe-1" colspan="2"
                                                                style="text-align: center;"><small class="text-danger">*
                                                                    Tenor
                                                                    melebihi batas usia maks. 56
                                                                    tahun!</small></td>
                                                        </tr>
                                                    @endif
                                                    <tr>
                                ...
                                <div class="card-body invoice-padding pb-0">
                                    <div
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @endif
                                            @php
                                                $total_score = $scoreDsr + $scoreUsia + $scoreTenor;
                                            @endphp
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>:
                                                                        @if ($deviasi)
                                                                            <span
                                                                                class="badge rounded-pill badge-glow bg-success">Diterima
                                                                                (Deviasi)</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="">
                                                    ...
                                                    <button type="submit" class="btn w-100"
                                                        style="background-color:darkorange; color:wheat;" disabled><i
                                                            data-feather="printer"></i>
                                                        Cetak
                                                        Akad
                                                    </button>
                    ...
                    <div class="tab-pane" id="ideb" role="tabpanel" aria-labelledby="settings-tab-justified">
                        ...
                        @if ($pembiayaan->nasabah->status_pernikahan == 'Menikah')
                            ...
                            @if ($dokumenIdebPasangan)
                                <iframe src="{{ asset('storage/' . $dokumenIdebPasangan->foto) }}"
                                    class="d-block w-100" height="600"></iframe>
                            @else
                                <center>
                                    <br />
