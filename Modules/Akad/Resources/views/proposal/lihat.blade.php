                                    ...
                                    <div class="col-xl-12 col-md-8 col-12">
                                        <div class="card invoice-preview-card">
                                            <div class="content-body">
                                                <section id="nav-filled">
                                                    <div class="row match-height">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <ul class="nav nav-tabs nav-justified" id="komiteTab"
                                                                        role="tablist">
                                                                        <li class="nav-item">
                                                                            <a class="nav-link active" id="proposal-tab"
                                                                                data-bs-toggle="tab" href="#proposal"
                                                                                role="tab" aria-controls="proposal-just"
                                                                                aria-selected="true">Proposal</a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a class="nav-link" id="ftv-tab"
                                                                                data-bs-toggle="tab" href="#ftv"
                                                                                role="tab" aria-controls="ftv-just"
                                                                                aria-selected="true">FTV</a>
                                                                        </li>
                                                                        {{-- <li class="nav-item">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link" id="timeline-tab"
                                                                                data-bs-toggle="tab" href="#timeline"
                                                                    ...
                                                                    <div class="tab-content pt-1">
                                                                                ...
                                                                                <div class="card invoice-preview-card">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="row invoice-spacing">
                                                                                            ...
                                                                                            <div
                                                                                                class="col-xl-4 p-0 mt-xl-0 mt-2">
                                                                                                <h6 class="mb-1">
                                                                                                    Pendapatan :</h6>
                                                                                                <table>
                                                                                                    <tbody>
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-xl-5 p-0 mt-xl-0 mt-2">
                                                                                                            <p
                                                                                                                class="mb-1 fw-bold">
                                                                                                                Note :</p>
                                                                                                            <table>
                                                                        ...
                                                                        <!-- /proposal -->
                                                                        <div class="tab-pane" id="ftv"
                                                                            role="tabpanel" aria-labelledby="ftv-tab">
                                                                            <div
                                                ...
                                                <!-- Idir -->
                                                <div class="modal fade" id="dsr" tabindex="-1"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="content-body">
                                            ...
                                            <div class="tab-content pt-1">
                                                                ...
                                                                <div class="row invoice-spacing">
                                                                    <div class="col-xl-8 p-0">
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="pe-1">Tempat/Tgl Lahir
                                                                                    </td>
                                                                                    <td>:
                                                ...
                                                <div class="tab-pane" id="ideb" role="tabpanel"
                                                    ...
                                                    <iframe src="{{ asset('storage/' . $ideb->foto) }}"
                                                        frameborder="0" width="1000" height="900"></iframe>
                        ...
                        <!-- ideb  -->
                        <div class="modal fade" id="konfirmasibendahara" tabindex="-1"
                            aria-labelledby="addNewCardTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-transparent">
