<form method="POST" action="/ultra_mikro/proposal/{{ $pembiayaan->id }}" id="proposalUltraMikro" class="needs-validation"
    ...
    <div id="form" class="content" role="tabpanel" aria-labelledby="account-details-trigger">
        ...
        <div class="row">
            ...
            @endif
            <div class="mb-1 col-md-6">
                <label class="form-label" for="kolTerburuk"><small class="text-danger">*
                    </small>Kolektibilitas Terburuk</label>
                <select class="select2 w-100" name="kol_id" id="kolTerburuk"
                    data-placeholder="Pilih Kolektibilitas Terburuk" required>
                    <option value="">
                    </option>
                    <option value="1">1
                    </option>
