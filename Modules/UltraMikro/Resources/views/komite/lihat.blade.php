                                        ...
                                        <div class="tab-pane active show" id="proposal" role="tabpanel"
                                            ...
                                            <div class="col-xl-12 col-md-8 col-12">
                                                <div class="card invoice-preview-card">
                                                    ...
                                                    {{-- Recall variabel yang dibutuhkan --}}
                                                    @php
                                                        //Usia dalam bulan
                                                        $usiaInMonth =
                                                        ...
                                                        <div class="row invoice-spacing">
                                                            ...
                                                            <div class="col-xl-9 p-0 mt-xl-0 mt-2">
                                                                ...
                                                                @if ($history->status_id == 2)
                                                                    @if ($total_score >= 2.0)
                                                                        @if ($dsr > 75 || $tenor > $sisaUsia || $pendapatanBersih - $angsuran < 0)
                                                                ...
                                                                @endif
                                                                <form action="/ultra_mikro/cetak" target="_blank" class="d-inline-block m-0">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <form id="addNewCardValidation"
                                                                        class="row gy-1 gx-2 mt-75" method="POST"
                                                                        action="/ultra_mikro/bonMurabahah"
                                                                        enctype="multipart/form-data">
                                                                        @csrf
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <form id="formDeviasi" class="row gy-1 gx-2 mt-75"
                                                                        method="POST" action="/ultra_mikro/komite"
                                                                        enctype="multipart/form-data">
                                                                        @csrf
                                                                        <input type="hidden"
                                                                            name="ultra_mikro_pembiayaan_id"
                                                                        ...
                                                                        <div class="mb-1 col-md-12">
                                                                            <label class="form-label"
                                                                                for="kategoriDeviasi"><small
                                                                                    class="text-danger">*
                                                                                </small>Kategori</label>
                                                                            <select name="kategori_deviasi"
                                                                                id="kategoriDeviasi" class="select2 w-100"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <iframe
                                                                            src="https://docs.google.com/gview?url={{ asset('storage/' . $fotoSuratPermohonanRestruct->foto) }}&embedded=true"
