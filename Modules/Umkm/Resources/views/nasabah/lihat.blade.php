                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        ...
                                        <span>
                                            Rp. {{ number_format((float)($pembiayaan->omset ?? 0), 0, ',', '.') }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            @foreach ($datas as $data)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">Rp.
                                        {{ number_format((float)($data->nominal_pembiayaan ?? 0), 0, ',', '.') }}
                                    </td>
                                    <td style="text-align: center">{{ $data->tenor }} Bulan
                                    </td>
                                    <td style="text-align: center">
                                        {{ number_format((float)($data->rate ?? 0), 2, ',', '.') }} %
                                    </td>
                                    <td style="text-align: center">Rp. {{ number_format($angsuran1, 0, ',', '.') }}
                                    </td>
                                    <td style="text-align: center">
