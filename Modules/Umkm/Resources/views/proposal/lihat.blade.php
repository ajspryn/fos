                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nominal_pembiayaan"
                                                class="form-control numeral-mask1" placeholder="Nominal Pembiayaan"
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="nama_usaha" id="nama_usaha" class="form-control"
                                                placeholder="Masukan Nama Toko Atau Usaha"
                                                value="{{ $pembiayaan->keteranganusaha->nama_usaha }}">
                                        </div>
                                        <div class="mb-1 col-md-6">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" name="alamatusaha" id="alamatusaha"
                                                class="form-control" placeholder="Masukan Alamat Usaha" value="{{ $pembiayaan->keteranganusaha->alamatusaha }}" />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                ...
                                <div id="form6" class="content" role="tabpanel"
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text" class="form-control numeral-mask1" placeholder="Rp."
                                            name="omset" id="omset"
                                            value="{{ number_format($pembiayaan->omset) }}" disabled>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
