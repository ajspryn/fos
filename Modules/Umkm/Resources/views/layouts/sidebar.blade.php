...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('umkm/nasabah*') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ Request::is('umkm/komite*') ? 'active' : '' }}">
            <a href="/umkm/komite" class="menu-link">
                <i data-feather="file-text" class="menu-icon tf-icons"></i>
                <div data-i18n="Komite">Komite</div>
            </a>
        </li>
        <li class="menu-item {{ Request::is('umkm/proposal*') || Request::is('umkm/revisi*') ? 'open' : '' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('umkm/proposal*') ? 'active' : '' }}">
                ...
                <li class="menu-item {{ Request::is('umkm/revisi*') ? 'active' : '' }}">
