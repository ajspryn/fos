                                ...
                                <tbody>
                                    @forelse($komites as $komite)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">Rp.{{ number_format((float)($komite->nominal_pembiayaan ?? 0), 0, ',', '.') }}</td>
                                            ...
                                            <td>
                                                <a href="/umkm/revisi/{{ $komite->id }}/edit" class="btn btn-outline-info round">Detail</a>
                                            </td>
                                        </tr>
                                    @empty
