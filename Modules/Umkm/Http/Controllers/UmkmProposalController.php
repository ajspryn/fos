...
class UmkmProposalController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $jaminanutama = UmkmJaminan::select()->where('umkm_pembiayaan_id', $id)->first();
        return view('umkm::proposal.lihat', [
            ...
            'rumah' => UmkmLegalitasRumah::select()->where('umkm_pembiayaan_id', $pembiayaan->umkm_legalitas_rumah_id)->first(),
            'jaminanutama' => PasarJenisJaminan::select()->where('kode_jaminan', $jaminanutama->jaminanlain)->first(),
        ]);
    }
