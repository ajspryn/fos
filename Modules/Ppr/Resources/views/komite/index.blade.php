                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @forelse($proposals as $proposal)
                                        ...
                                        @php $statusId = $history?->statusHistory?->id; @endphp
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="/ppr/komite/{{ $proposal->id }}" class="btn btn-outline-info round">Detail</a>
                                            </td>
                                        </tr>
                                    @empty
