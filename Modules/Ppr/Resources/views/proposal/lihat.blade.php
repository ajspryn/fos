    ...
    <div class="app-content content ">
        ...
        <div class="content-body">
            ...
            <div class="tab-content pt-1 container-xxl">
                <div class="tab-pane active show" id="form-pembiayaan" role="tabpanel"
                    ...
                    <section id="section_pembiayaan" class="modern-horizontal-wizard">
                        <div class="bs-stepper wizard-modern modern-wizard-example">
                            ...
                            <div class="bs-stepper-content">
                                <form action="/ppr/proposal/{{ $pembiayaan->id }}" class="needs-validation"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" name="form_permohonan_uang_muka_dana_sendiri"
                                                    ...
                                                    class="form-control numeral-mask" placeholder="Uang Muka/Dana Sendiri"
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" name="form_permohonan_nilai_hpp"
                                                    id="form_permohonan_nilai_hpp" class="form-control  numeral-mask"
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" name="form_permohonan_harga_jual"
                                                    id="form_permohonan_harga_jual" class="form-control numeral-mask"
                                            ...
                                            <div class="mb-1 col-md-6 {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'Murabahah' ? 'show' : 'hide' }}"
                                                ...
                                                <input type="text" name="form_permohonan_jml_margin"
                                                    ...
                                                    class="form-control numeral-mask {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'Murabahah' ? 'show' : 'hide' }}"
                                            ...
                                            <div class="mb-1 col-md-6 {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'IMBT' ? 'show' : 'hide' }}"
                                                ...
                                                <input type="text" name="form_permohonan_jml_sewa"
                                                    ...
                                                    class="form-control numeral-mask {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'IMBT' ? 'show' : 'hide' }}"
                                            ...
                                            <div class="mb-1 col-md-6 {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'MMQ' ? 'show' : 'hide' }}"
                                                ...
                                                <input type="text" name="form_permohonan_jml_bagi_hasil"
                                                    ...
                                                    class="form-control numeral-mask {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'MMQ' ? 'show' : 'hide' }}"
                                            ...
                                            <div class="mb-1 col-md-6 {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'Akad Lainnya' ? 'show' : 'hide' }}"
                                                ...
                                                <input type="text" name="form_permohonan_jml_margin"
                                                    ...
                                                    class="form-control numeral-mask {{ $pembiayaan->form_permohonan_jenis_akad_pembayaran == 'Akad Lainnya' ? 'show' : 'hide' }}"
                                    ...
                                    <div id="formDataPribadi" class="content" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" id="form_pribadi_pemohon_tanggal_lahir"
                                                    class="form-control flatpickr-basic"
                                                    name="form_pribadi_pemohon_tanggal_lahir" placeholder="DD-MM-YYYY"
                                                    value="{{ date('d-m-Y', strtotime($pembiayaan->pemohon->form_pribadi_pemohon_tanggal_lahir)) }}" />
                                            </div>
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <div class="row {{ $pembiayaan->pemohon->form_pribadi_pemohon_status_pernikahan == 'Menikah' ? 'show' : 'hide' }}"
                                                    ...
                                                    <div class="mb-1 col-md-6">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ date('d-m-Y', strtotime($pembiayaan->pemohon->form_pribadi_istri_suami_tanggal_lahir)) }}" />
                                                    </div>
                                                    <div class="mb-1 col-md-6">
                                                        <label class="form-label"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control numeral-mask" placeholder="Total Pengeluaran"
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control numeral-mask" placeholder="Sisa Penghasilan"
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control numeral-mask" placeholder="Total Penghasilan"
                                    ...
                                    <div id="formDataAgunan" class="content" role="tabpanel"
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div data-repeater-item>
                                                        <div class="row d-flex align-items-end">
                                                            ...
                                                            <div class="mb-1 col-md-3 {{ $pembiayaan->agunan->form_agunan_1_status_bukti_kepemilikan == 'SHGB' ? 'show' : 'hide' }}"
                                                                ...
                                                                <input type="text" id="tglBerakhirShgbAgunan1"
                                                                    class="form-control flatpickr-basic"
                                                                    name="form_agunan_1_status_bukti_kepemilikan_tgl_berakhir"
                                                                    placeholder="DD-MM-YYYY"
                                                                    value="{{ date('d-m-Y', strtotime($pembiayaan->agunan->form_agunan_1_status_bukti_kepemilikan_tgl_berakhir)) }}" />
                                                            </div>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" id="form_agunan_1_no_sertifikat_tgl_penerbitan"
                                                    class="form-control flatpickr-basic"
                                                    name="form_agunan_1_no_sertifikat_tgl_penerbitan"
                                                    placeholder="DD-MM-YYYY"
                                                    value="{{ date('d-m-Y', strtotime($pembiayaan->agunan->form_agunan_1_no_sertifikat_tgl_penerbitan)) }}"
                                                    required />
                                            </div>
                                            <div class="mb-1 col-md-6">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="row d-flex align-items-end">
                                                            ...
                                                            <div class="mb-1 col-md-3 {{ $pembiayaan->agunan->form_agunan_2_status_bukti_kepemilikan == 'SHGB' ? 'show' : 'hide' }}"
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="DD-MM-YYYY"
                                                                    value="{{ date('d-m-Y', strtotime($pembiayaan->agunan->form_agunan_2_status_bukti_kepemilikan_tgl_berakhir)) }}" />
                                                            </div>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label"
                                                    ...
                                                    Penerbitan</label>
                                                <input type="text" id="form_agunan_2_no_sertifikat_tgl_penerbitan"
                                                    class="form-control flatpickr-basic"
                                                    name="form_agunan_2_no_sertifikat_tgl_penerbitan"
                                                    placeholder="DD-MM-YYYY"
                                                    value="{{ date('d-m-Y', strtotime($pembiayaan->agunan->form_agunan_2_no_sertifikat_tgl_penerbitan)) }}" />
                                            </div>
                                            <div class="mb-1 col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <input type="text" name="form_agunan_3_nilai"
                                                    id="form_agunan_3_nilai" class="form-control numeral-mask"
                                                                    ...
                                                                    <div class="row d-flex align-items-end">
                                                                        ...
                                                                        <div class="mb-1 col-md-2">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="DD-MM-YYYY"
                                                                                value="{{ date('d-m-Y', strtotime($kekayaan_simpanan->form_kekayaan_simpanan_saldo_per_tanggal)) }}" />
                                                                        </div>
                                                    ...
                                                    <div class="row d-flex align-items-end">
                                                        ...
                                                        <div class="mb-1 col-md-2">
                                                            <label class="form-label"
                                                                ...
                                                                Per
                                                                Tanggal</label>
                                                            <input type="text" id="form_kekayaan_saham_per_tanggal"
                                                                class="form-control flatpickr-basic"
                                                                name="form_kekayaan_saham_per_tanggal"
                                                                placeholder="DD-MM-YYYY"
                                                                value="{{ date('d-m-Y', strtotime($kekayaan_saham->form_kekayaan_saham_per_tanggal)) }}" />
                                                        </div>
                                        ...
                                        <div class="row d-flex align-items-end">
                                            ...
                                            <div class="mb-1 col-md-2">
                                                ...
                                                <input type="date" id="form_kekayaan_saham_per_tanggal"
                                                    class="form-control flatpickr-basic"
                                                    name="form_kekayaan_saham_per_tanggal" placeholder="DD-MM-YYYY" />
                                            </div>
        ...
        @else
            <div class="row">
                <div class="mb-1 col-md-6">
                    ...
                    <input type="file" name="dokumen_pemohon" id="dokumen_pemohon" class="form-control"
                        required />
                </div>
                <div class="mb-1 col-md-6">
                    <label class="form-label" for="dokumen_agunan"><small class="text-danger">*
                        </small>Upload Dokumen Agunan</label>
                    <input type="file" name="dokumen_agunan" id="dokumen_agunan" class="form-control" required />
                </div>
                <div class="mb-1 col-md-6">
                    <label class="form-label" for="ots_agunan"><small class="text-danger">*
                        </small>Upload OTS Agunan
                    </label>
                    <input type="file" name="ots_agunan" id="ots_agunan" class="form-control" required />
                </div>
                <div class="mb-1 col-md-6">
                    <label class="form-label" for="ots_tempat_usaha"><small class="text-danger">*
                        </small>Upload OTS Tempat
                        Usaha </label>
                    <input type="file" name="ots_tempat_usaha" id="ots_tempat_usaha" class="form-control"
                        required />
                </div>
                <div class="mb-1 col-md-6">
                    ...
                    <input type="file" name="hasil_wawancara" id="hasil_wawancara" class="form-control"
                        required />
                </div>
                <div class="mb-1 col-md-6">
                    ...
                    <input type="file" name="appraisal_kjpp" id="appraisal_kjpp" class="form-control" required />
                </div>
            </div>
        @endif
        <div>
    ...
    <div class="tab-pane" id="check-list" role="tabpanel" aria-labelledby="check-list-justified">
        <section id="section_checklist" class="modern-horizontal-wizard">
            <div class="bs-stepper wizard-modern modern-wizard-example">
                ...
                <div class="bs-stepper-content">
                    <form action="/ppr/proposal/{{ $pembiayaan->id }}" id="formPpr" class="needs-validation"
                        method="POST" enctype="multipart/form-data" novalidate>
                        @method('PUT')
                        @csrf
                        @if ($pembiayaan->dilengkapi_ao == 'Telah dilengkapi')
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="gajiKotor1"
                                                        class="form-control numeral-mask" name="gaji1_gaji_kotor"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="gajiKotor2"
                                                        class="form-control numeral-mask" name="gaji2_gaji_kotor"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                        placeholder="Gaji 2"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="thtGaji1"
                                                        class="form-control numeral-mask" name="gaji1_potongan_tht"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="thtGaji2"
                                                        class="form-control numeral-mask" name="gaji2_potongan_tht"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                        placeholder="Potongan THT"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="koperasiGaji1"
                                                        class="form-control numeral-mask" name="gaji1_potongan_koperasi"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td
                                                    ...
                                                    <input type="text" id="koperasiGaji2"
                                                        class="form-control numeral-mask" name="gaji2_potongan_koperasi"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                        placeholder="Potongan Koperasi"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="lainGaji1"
                                                        class="form-control numeral-mask" name="gaji1_potongan_lain"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="lainGaji2"
                                                        class="form-control numeral-mask" name="gaji2_potongan_lain"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                        placeholder="Potongan lain-lain"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="angsuranRumah"
                                                        class="form-control numeral-mask" name="angsuran_rumah"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="angsuranMobil"
                                                        class="form-control numeral-mask" name="angsuran_mobil"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="angsuranLainnya"
                                                        class="form-control numeral-mask" name="angsuran_lain"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaPangan"
                                                        class="form-control numeral-mask" name="biaya_pangan"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaSandang"
                                                        class="form-control numeral-mask" name="biaya_sandang"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaTransportasi"
                                                        class="form-control numeral-mask" name="biaya_transportasi"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaListrik"
                                                        class="form-control numeral-mask" name="biaya_listrik"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaTelepon"
                                                        class="form-control numeral-mask" name="biaya_telepon"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaGas"
                                                        class="form-control numeral-mask" name="biaya_gas"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaAir"
                                                        class="form-control numeral-mask" name="biaya_air"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaPendidikan"
                                                        class="form-control numeral-mask" name="biaya_pendidikan"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaKesehatan"
                                                        class="form-control numeral-mask" name="biaya_kesehatan"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaLain"
                                                        class="form-control numeral-mask" name="biaya_lain"
                                                        onkeyup="sumFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="penjualanNF1"
                                                        class="form-control numeral-mask" name="usaha1_penjualan"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="penjualanNF2"
                                                        class="form-control numeral-mask" name="usaha2_penjualan"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="diskonNF1"
                                                        class="form-control numeral-mask" name="usaha1_diskon"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="diskonNF2"
                                                        class="form-control numeral-mask" name="usaha2_diskon"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="diskonNFP"
                                                        class="form-control numeral-mask" name="usaha_pasangan_diskon"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="returNF1"
                                                        class="form-control numeral-mask" name="usaha1_retur"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="returNF2"
                                                        class="form-control numeral-mask" name="usaha2_retur"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="returNFP"
                                                        class="form-control numeral-mask" name="usaha_pasangan_retur"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="upahLangsungNF1"
                                                        class="form-control numeral-mask" name="usaha1_upah_langsung"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="upahLangsungNF2"
                                                        class="form-control numeral-mask" name="usaha2_upah_langsung"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="penyusutanNF1"
                                                        class="form-control numeral-mask" name="usaha1_biaya_penyusutan"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="penyusutanNF2"
                                                        class="form-control numeral-mask" name="usaha2_biaya_penyusutan"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="bohLainNF1"
                                                        class="form-control numeral-mask" name="usaha1_boh_lain"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="bohLainNF2"
                                                        class="form-control numeral-mask" name="usaha2_boh_lain"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="bohLainNFP"
                                                        class="form-control numeral-mask" name="usaha_pasangan_boh_lain"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaPenjualanNF1"
                                                        class="form-control numeral-mask" name="usaha1_biaya_penjualan"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaPenjualanNF2"
                                                        class="form-control numeral-mask" name="usaha2_biaya_penjualan"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaGajiKomisarisDireksiStaffNF1"
                                                        class="form-control numeral-mask" name="usaha1_biaya_gaji_kds"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaGajiKomisarisDireksiStaffNF2"
                                                        class="form-control numeral-mask" name="usaha2_biaya_gaji_kds"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaAdmLainNF1"
                                                        class="form-control numeral-mask" name="usaha1_jml_biaya_adm"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="biayaAdmLainNF2"
                                                        class="form-control numeral-mask" name="usaha2_jml_biaya_adm"
                                                        placeholder="Sub Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="pajakZakatNF1"
                                                        class="form-control numeral-mask" name="usaha1_pajak_zakat"
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" id="pajakZakatNF2"
                                                        class="form-control numeral-mask" name="usaha2_pajak_zakat"
                                                        placeholder="Total" onkeyup="sumNonFixed(this.value);"
                                                        oninput="this.value=this.value.replace(/[^0-9.]/g,'').replace(/(\..*)\./g, '$1');"
    ...
    <div class="tab-pane" id="scoring" role="tabpanel" aria-labelledby="scoring-justified">
        <section id="section_scoring" class="modern-horizontal-wizard">
            <div class="bs-stepper wizard-modern modern-wizard-example">
                ...
                <div class="bs-stepper-content">
                    <form action="/ppr/proposal/{{ $pembiayaan->id }}" class="needs-validation" method="POST"
                        novalidate>
                        @method('PUT')
                        @csrf
                        @if ($pembiayaan->dilengkapi_ao == 'Telah dilengkapi' && $pembiayaan->form_cl == 'Telah diisi')
