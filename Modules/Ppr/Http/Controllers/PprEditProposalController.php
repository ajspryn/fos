...
class PprEditProposalController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('ppr::revisi.lihat', [
            ...
            //Fixed income
            'character' => PprCharacter::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'capital' => PprCapital::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'capacity' => PprCapacity::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'condition' => PprCondition::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'collateral' => PprCollateral::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),

            //Non Fixed Income
            'characterNf' => pprCharacterNonFixed::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'capacityNf' => PprCapacityNonFixed::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'conditionNf' => PprConditionNonFixed::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
            'collateralNf' => PprCollateralNonFixed::select()->where('form_ppr_pembiayaan_id', $id)->get()->first(),
