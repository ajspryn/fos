...
class P3kKomiteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->status_id == 11) {
            return redirect('/analis/p3k/komite/')->with('success', 'Proposal Berhasil Direkomendasikan!');
        } elseif ($request->status_id == 7) {
            return redirect('/analis/p3k/komite/')->with('success', 'Proposal Diajukan Untuk Revisi!');
        } else {
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('analis::p3k.komite.lihat', [
