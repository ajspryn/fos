...
class AnalisController extends Controller
{
    ...
    public function index()
    {
        ...
        $proposalskpd = DB::query()
            ...
            ->where(function ($q) {
                $q->where(function ($q2) {
                    $q2->where('sh2.status_id', 3)->where('sh2.jabatan_id', 1);
                })->orWhere(function ($q2) {
        ...
        $data = DB::query()
            ...
            ->where(function ($q) {
                $q->where(function ($q2) {
                    $q2->where('ph2.status_id', 3)->where('ph2.jabatan_id', 1);
                })->orWhere(function ($q2) {
        ...
        $a = DB::query()
            ...
            ->where(function ($q) {
                $q->where(function ($q2) {
                    $q2->where('uh2.status_id', 3)->where('uh2.jabatan_id', 1);
                })->orWhere(function ($q2) {
        ...
        $proposalppr = DB::query()
            ...
            ->where(function ($q) {
                $q->where(function ($q2) {
                    $q2->where('prh2.status_id', 3)->where('prh2.jabatan_id', 1);
                })->orWhere(function ($q2) {
        ...
        $disburseumkm = $cairumkm->sum('nominal_pembiayaan');
        $disburseskpd = $cairskpd->sum('nominal_pembiayaan');
