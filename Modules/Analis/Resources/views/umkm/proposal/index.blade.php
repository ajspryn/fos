                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form method="GET" action="/analis/umkm/proposal" class="d-flex gap-2">
                                    <input type="text" name="search" class="form-control" placeholder="Cari nama nasabah/alamat..." value="{{ request('search') }}">
                                    <button type="submit" class="btn btn-primary">Cari</button>
                                    <a href="/analis/umkm/proposal" class="btn btn-secondary">Reset</a>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse ($proposals as $proposal)
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">{{ number_format((float)str_replace('.', '', $proposal->nominal_pembiayaan ?? '0')) }}</td>
