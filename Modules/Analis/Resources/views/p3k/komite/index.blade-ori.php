                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    @foreach ($proposals as $proposal)
                                        @php
                                            $proposal_p3k = Modules\P3k\Entities\P3kPembiayaan::select()
                                                ->where('id', $proposal->p3k_pembiayaan_id)
                                                ->first();

                                            $history = Modules\P3k\Entities\P3kPembiayaanHistory::where('p3k_pembiayaan_id', $proposal_p3k->id)
                                                ->latest()
                                                ->first();
                                        @endphp
                                        @if ($history->status_id == 5 || $history->status_id == 4 || $history->status_id >= 9)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    Rp.
                                                    {{ number_format($proposal_p3k->nominal_pembiayaan, 0, ',', '.') }}
                                                </td>
                                                <td style="text-align: center">
                                                    {{ $proposal_p3k->tenor }}
                                                </td>
                                                ...
                                                <td style="text-align: center">{{ $proposal_p3k->user->name }}
                                                </td>
                                                <td style="text-align: center">
                                    ...
                                    @foreach ($proposals as $forCatatanModal)
                                        @php
                                            $proposal_p3k = Modules\P3k\Entities\P3kPembiayaan::select()
                                                ->where('id', $forCatatanModal->p3k_pembiayaan_id)
                                                ->first();

                                            $historyCatatan = Modules\P3k\Entities\P3kPembiayaanHistory::where('p3k_pembiayaan_id', $proposal_p3k->id)
                                                ->latest()
                                                ->first();
                                        @endphp
