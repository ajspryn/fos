                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/analis">P3K</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/analis/p3k/nasabah">Data Nasabah</a>
                                    </li>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-around my-2 pt-75">
                        ...
                        <div class="d-flex align-items-start me-2">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">
                                    {{ $pembiayaan->nasabah->pekerjaan->nama_unit_kerja }}</h5>
                                <small> {{ $pembiayaan->nasabah->pekerjaan->jabatan }}</small>
                            </div>
                        </div>
                    </div>
