                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form method="GET" action="/analis/skpd/nasabah" class="d-flex gap-2">
                                    <input type="text" name="search" class="form-control" placeholder="Cari nama nasabah / NIK..." value="{{ request('search') }}">
                                    <button type="submit" class="btn btn-primary">Cari</button>
                                    <a href="/analis/skpd/nasabah" class="btn btn-secondary">Reset</a>
                                </form>
                            </div>
                                        ...
                                        @forelse ($proposals as $proposal)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="/analis/skpd/nasabah/{{ $proposal->id }}" class="btn btn-outline-info round">Detail</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
