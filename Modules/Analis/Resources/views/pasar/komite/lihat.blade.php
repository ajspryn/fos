                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="tab-pane" id="identitas-pribadi" role="tabpanel"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    @if ($fotodiribersamaktp && $fotodiribersamaktp->foto)
                                                        <div class="d-flex justify-content-start align-items-center mb-1">
                                                            <div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    @if ($nota && $nota->foto)
                                                        ...
                                                        <!--/ post img -->
                                                    @else
                                                        <div class="text-center text-muted">Foto nota pembelanjaan belum tersedia.</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    @if ($fototoko && $fototoko->foto)
                                                        ...
                                                        <!--/ post img -->
                                                    @else
                                                        <div class="text-center text-muted">Foto kios/los belum tersedia.</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
