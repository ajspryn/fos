                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/analis">Ultra Mikro</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/analis/ultra_mikro/nasabah">Data Nasabah</a>
                                    </li>
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            <img class="img-fluid rounded mb-75" src="{{ asset('storage/' . $fotoKtp->foto) }}"
                    ...
                    <div class="d-flex justify-content-around my-2 pt-75">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">{{ $nasabah->alamat_domisili }}</small>
                            </div>
                        </div>
                        <div class="d-flex align-items-start me-2">
                            <span class="badge bg-light-primary p-75 rounded">
                            ...
                            <div class="ms-75">
                                <h5 class="mb-0">
                                    {{ $pembiayaan->nasabah->nama_pekerjaan }}</h5>
                            </div>
                        </div>
                    </div>
                            ...
                            {{-- <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        ...
                                        <span> {{ $pembiayaan->nasabah->pekerjaan->nama_unit_kerja }}</span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25"> Jabatan : </span>
                                        <span> {{ $pembiayaan->nasabah->pekerjaan->jabatan }}</span>
                                    </li>
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="/ultra_mikro/komite/{{ $data->id }}"
