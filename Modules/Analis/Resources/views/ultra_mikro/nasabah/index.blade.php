                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form method="GET" action="/analis/ultra_mikro/nasabah" class="d-flex gap-2">
                                    <input type="text" name="search" class="form-control" placeholder="Cari nama nasabah / NIK..." value="{{ request('search') }}">
                                    <button type="submit" class="btn btn-primary">Cari</button>
                                    <a href="/analis/ultra_mikro/nasabah" class="btn btn-secondary">Reset</a>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse ($proposals as $proposal)
                                            <tr>
                                                ...
                                                <td>{{ $proposal->alamat_domisili }}</td>
                                                <td style="text-align: center">
                                                    <a href="/analis/ultra_mikro/nasabah/{{ $proposal->id }}" class="btn btn-outline-info round">Detail</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="5" style="text-align: center">Tidak ada data nasabah.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
