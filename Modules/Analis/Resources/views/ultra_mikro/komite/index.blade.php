                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form method="GET" action="/analis/ultra_mikro/komite" class="d-flex gap-2">
                                    <input type="text" name="search" class="form-control" placeholder="Cari nama / NIK..." value="{{ request('search') }}">
                                    <button type="submit" class="btn btn-primary">Cari</button>
                                    <a href="/analis/ultra_mikro/komite" class="btn btn-secondary">Reset</a>
                                </form>
                            </div>
                                    ...
                                    @forelse ($proposals as $proposal)
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td style="text-align: center">Rp. {{ number_format((float)str_replace('.', '', $proposal->nominal_pembiayaan ?? '0'), 0, ',', '.') }}</td>
                                                <td style="text-align: center">{{ $proposal->tenor }}</td>
                                                <td style="text-align: center">
                                                ...
                                                <td style="text-align: center">
                                                    <a href="/analis/ultra_mikro/komite/{{ $proposal->id }}" class="btn btn-outline-info round">Detail</a>
                                                </td>
                                            </tr>
                                    @empty
