...
namespace Modules\Analis\Providers;
...
class AnalisServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'Analis';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'analis';
    ...
    public function boot()
    {
        ...
        View::composer('analis::layouts.sidebar', function ($view) {
            $data = Cache::remember('analis:sidebar:stats', 300, function () {
                ...
                $proposalSkpd = DB::query()
                    ...
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            ...
                            $q2->where('sh2.status_id', 4)->where('sh2.jabatan_id', 3);
                        });
                    })
                    ->count();
                ...
                $data = DB::query()
                    ...
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            ...
                            $q2->where('ph2.status_id', 4)->where('ph2.jabatan_id', 3);
                        });
                    })
                    ->count();
                ...
                $a = DB::query()
                    ...
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            ...
                            $q2->where('uh2.status_id', 4)->where('uh2.jabatan_id', 3);
                        });
                    })
                    ->count();
                ...
                $proposalppr = DB::query()
                    ...
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            ...
                            $q2->where('prh2.status_id', 4)->where('prh2.jabatan_id', 3);
                        });
                    })
                    ->count();
                ...
                $proposalP3k = DB::query()
                    ...
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            ...
                            $q2->where('p3h2.status_id', 4)->where('p3h2.jabatan_id', 3);
                        });
                    })
                    ->count();

                $komiteUltraMikro = DB::query()
                    ->fromSub($ultraLatest, 'ul')
                ...
                $proposalUltraMikro = DB::query()
                    ->fromSub($ultraLatest, 'ul2')
                    ->join('ultra_mikro_pembiayaan_histories as uh2', 'uh2.id', '=', 'ul2.latest_id')
                    ->where(function ($q) {
                        $q->where(function ($q2) {
                            $q2->where('uh2.status_id', 11)->where('uh2.jabatan_id', 1);
                        })->orWhere(function ($q2) {
