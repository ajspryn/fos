...
class UmkmKomiteController extends Controller
{
    ...
    public function index()
    {
        ...
        $latestHistories = UmkmPembiayaanHistory::joinSub($latestSub, 'lh', function ($join) {
            ...
            ->get(['umkm_pembiayaan_histories.umkm_pembiayaan_id', 'status_id', 'jabatan_id', 'user_id']);
        ...
        $histories = $latestHistories->whereIn('umkm_pembiayaan_id', $komiteIds)->keyBy('umkm_pembiayaan_id');
    ...
    public function show($id)
    {
        ...
        return view('kabag::umkm.komite.lihat', [
            ...
            'bon_murabahah' => UmkmFoto::select()->where('umkm_pembiayaan_id', $id)->where('kategori', 'Foto Bon Murabahah')->first(),
