                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <div class="card-body">
                                                                                                                                                <iframe src="{{ asset('storage/' . optional($deviasi)->dokumen_deviasi) }}" class="d-block w-100"
                                ...
                                <hr class="invoice-spacing" />
                                        ...
                                        <iframe src="{{ asset('storage/' . optional($pembiayaan)->dokumen_keuangan) }}" class="d-block w-100"
