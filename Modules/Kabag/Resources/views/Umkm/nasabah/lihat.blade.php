                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag">UMKM</a>
                                    </li>
                    ...
                    <div class="d-flex justify-content-around my-2 pt-75">
                        ...
                        <div class="d-flex align-items-start me-2">
                            ...
                            <div class="ms-75">
                                ...
                                <small>
                                    Pasar {{ $pembiayaan->keteranganusaha->alamatusaha }}</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">Alamat Usaha : </span>
                                        <span>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="/kabag/umkm/komite/{{ $data->id }}"
