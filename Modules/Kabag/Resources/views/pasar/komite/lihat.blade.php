                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-3">
                                        <div class="tab-pane active show" id="proposal"
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>: <span class="fw-bold"><span class="badge rounded-pill badge-glow bg-warning">Tinjau Ulang</span></span></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pe-1 mb-2">Nilai > 3</td>
                                                                                <td>: <span class="fw-bold"><span class="badge rounded-pill badge-glow bg-success">Diterima</span></span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                            ...
                                            @if ($deviasi && $deviasi->dokumen_deviasi)
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body ">
                                                                ...
                                                                <div class="card-body">
                                                                    <iframe
                                                                        src="{{ asset('storage/' . optional($deviasi)->dokumen_deviasi) }}"
                                        ...
                                        <div class="tab-pane" id="identitas-pribadi" role="tabpanel"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">{{ optional($fotodiri)->kategori }}</h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                {{ optional(optional($fotodiri)->created_at)->diffForhumans() }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="{{ asset('storage/' . optional($fotodiri)->foto) }}"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">{{ optional($fotoktp)->kategori }}</h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                {{ optional(optional($fotoktp)->created_at)->diffForhumans() }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="{{ asset('storage/' . optional($fotoktp)->foto) }}"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">{{ optional($fotodiribersamaktp)->kategori }}</h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                {{ optional(optional($fotodiribersamaktp)->created_at)->diffForhumans() }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="{{ asset('storage/' . optional($fotodiribersamaktp)->foto) }}"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">{{ optional($fotokk)->kategori }}</h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                {{ optional(optional($fotokk)->created_at)->diffForhumans() }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="{{ asset('storage/' . optional($fotokk)->foto) }}"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                            ...
                                            @if ($nota)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="{{ asset('storage/' . optional($nota)->foto) }}"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                            ...
                                            @if ($bon_murabahah)
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="{{ asset('storage/' . optional($bon_murabahah)->foto) }}"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center mb-1">
                                                        <div>
                                                            <h6 class="mb-0">Foto Kios / Los :
                                                                {{ optional($fototoko)->kategori }}
                                                            </h6>
                                                            <small class="text-muted">Diupload Pada :
                                                                {{ optional(optional($fototoko)->created_at)->diffForhumans() }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- post img -->
                                                    <img class="img-fluid rounded mb-75"
                                                        src="{{ asset('storage/' . optional($fototoko)->foto) }}"
                                                        alt="avatar img" />
                                                    <!--/ post img -->
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="ideb" role="tabpanel"
                                            ...
                                            <iframe src="{{ asset('storage/' . optional($pembiayaan)->dokumen_keuangan) }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-12 mx-50 pb-5">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12 d-flex order-md-2 order-1">
                                        <img src="{{ asset('storage/' . optional($fototoko)->foto) }}" class="d-block w-100"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-12 mx-50 pb-5">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12 d-flex order-md-2 order-1">
                                        <img src="{{ asset('storage/' . optional($jaminan)->dokumenktb) }}" class="d-block w-100"
                                            height='500' weight='800'>
                                    </div>
                                </div>
                            </div>
