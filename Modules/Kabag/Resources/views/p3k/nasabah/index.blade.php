    ...
    <div class="app-content content ">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag/p3k">P3K</a>
                                    </li>
            ...
            <section id="basic-datatable">
                ...
                <form method="GET" action="/kabag/p3k/nasabah" class="d-flex gap-2">
                    <input type="text" name="search" class="form-control" placeholder="Cari nama nasabah..." value="{{ request('search') }}">
                    <button type="submit" class="btn btn-primary">Cari</button>
                    <a href="/kabag/p3k/nasabah" class="btn btn-secondary">Reset</a>
                </form>
            </div>
                                    ...
                                    @forelse ($proposals as $proposal)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="/kabag/p3k/nasabah/{{ $proposal->id }}"
