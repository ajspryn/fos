            ...
            <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span
                ...
                <ul class="menu-content">
                    <li class="{{ Request::is('kabag/umkm/nasabah') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="/kabag/umkm/nasabah"><span
                                class="menu-item text-truncate" data-i18n="Account">Data Nasabah</span></a>
                    </li>
                    <li class="{{ Request::is('kabag/umkm/komite') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="/kabag/umkm/komite"><span
                                class="menu-item text-truncate" data-i18n="Security">Komite</span></a>
                    </li>
                    <li class="{{ Request::is('kabag/umkm/proposal') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="/kabag/umkm/proposal"><span
                                class="menu-item text-truncate" data-i18n="Security">Proposal</span><span
                                class="badge badge-light-success rounded-pill ms-auto me-1"></span></a>
                    </li>
                </ul>
