                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag/pprx/komite/{{ $proposal->id }}">PPR</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/kabag/pprx/komite/{{ $proposal->id }}">Proposal</a>
                                    </li>
                                ...
                                <tbody class="table-border-bottom-0">
                                        <tr>
                                                <td style="text-align: center">
                                                    <a href="/kabag/pprx/komite/{{ $proposal->id }}" class="btn btn-icon btn-icon rounded-circle btn-flat-success">
                                                ...
                                                <td style="text-align: center">
                                                    <a href="/kabag/pprx/komite/{{ $proposal->id }}"
                                                        class="btn btn-outline-info round">Detail</a>
                                                </td>
                                <td style="text-align: center">
                                    <a href="/kabag/pprx/komite/{{ $proposal->id }}" class="btn btn-outline-info btn-sm round">Detail</a>
                                </td>
                                </tr>
                                    </tbody>
                            </table>
