                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <iframe
                                                                        src="{{ asset('storage/' . optional($lampiran)->dokumen_pemohon) }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <iframe
                                                                        src="{{ asset('storage/' . optional($lampiran)->hasil_wawancara) }}"
                                                                        class="d-block w-100" height="600"></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                    ...
                                                                    <iframe
                                                                        src="{{ asset('storage/' . optional($lampiran)->dokumen_agunan) }}"
                                                                        class="d-block w-100" height="600"></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
