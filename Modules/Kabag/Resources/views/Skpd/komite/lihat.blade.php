                                    ...
                                    <div class="tab-content mt-3">
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:
                                                                                {{ optional($pembiayaan->sektor)->nama_sektor_ekonomi ?? '-' }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="pe-1">Akad</td>
                                                                            <td>: {{ optional($pembiayaan->akad)->nama_akad ?? '-' }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body px-sm-5 mx-50 pb-5">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <iframe
                                                                                src="{{ asset('storage/' . $deviasi->first()->dokumen_deviasi) }}"
                                            ...
                                            @foreach ($fotos as $foto)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <iframe src="{{ asset('storage/' . optional($foto)->foto) }}"
                                            ...
                                            @foreach ($jaminans as $jaminan)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="{{ asset('storage/' . optional($jaminan)->dokumen_jaminan) }}"
                                                            alt="avatar img" />
                                                            <iframe src="{{ asset('storage/' . optional($jaminan)->dokumen_jaminan) }}"
                                                            class="d-block w-100" height='500' weight='800'></iframe>
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($jaminanlainnyas as $jaminanlainnya)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="{{ asset('storage/' . optional($jaminanlainnya)->dokumen_jaminan_lainnya) }}"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($skpengangkatans as $skpengangkatan)
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- post img -->
                                                        <img class="img-fluid rounded mb-75"
                                                            src="{{ asset('storage/' . optional($skpengangkatan)->sk_pengangkatan) }}"
                                                            alt="avatar img" />
                                                        <!--/ post img -->
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="keuangan" role="tabpanel"
                                            ...
                                            <embed type="application/pdf"
                                                src="{{ asset('storage/' . optional($pembiayaan)->dokumen_keuangan) }}"
                                                width="1000" height="900">
                                            <embed type="application/pdf"
                                                src="{{ asset('storage/' . optional($pembiayaan)->dokumen_slip_gaji) }}"
                                                width="1000" height="900">
                                                @isset($bon_murabahah)
                                                <div class="card">
                                                    <div class="card-body">
                                        ...
                                        <div class="tab-pane" id="ideb" role="tabpanel"
                                            ...
                                            <iframe src="{{ asset('storage/' . optional($ideb)->foto) }}" frameborder="0"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-12 mx-50 pb-5">
                                ...
                                <div class="card-body">
                                    <iframe src="{{ asset('storage/' . optional($ideb)->foto) }}" class="d-block w-100"
