                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kabag">Ultra Mikro</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/kabag/ultra_mikro/nasabah">Data Nasabah</a>
                                    </li>
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                            <img class="img-fluid rounded mb-75" src="{{ asset('storage/' . optional($fotoKtp)->foto) }}"
