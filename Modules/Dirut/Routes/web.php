...
use Modules\Dirut\Http\Controllers\P3kKomiteController;

Route::prefix('dirut')->middleware(['auth:sanctum', 'role:2', 'divisi:0', 'jabatan:5'])->group(function () {
    Route::get('/', 'DirutController@index')->name('dirut.index');
    Route::prefix('skpd')->group(function () {
        ...
        Route::resource('/', SkpdProposalController::class)->names('dirut.skpd.proposal');
    ...
    Route::prefix('umkm')->group(function () {
        ...
        Route::resource('/', UmkmProposalController::class)->names('dirut.umkm.proposal');
    ...
    Route::prefix('pasar')->group(function () {
        ...
        Route::resource('/', PasarProposalController::class)->names('dirut.pasar.proposal');
    ...
    Route::prefix('ppr')->group(function () {
        ...
        Route::resource('/', PprProposalController::class)->names('dirut.ppr.proposal');
        // Route::resource('/nasabah', PprNasabahController::class);
    });

    Route::prefix('p3k')->group(function () {
        Route::resource('/komite', P3kKomiteController::class)->names('dirut.p3k.komite');
    });
});
