...
<html
  ...
  <head>
    ...
    <title>Demo: Accordion - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingCustomThree">
                        <button
                          ...
                          class="accordion-button collapsed"
                          data-bs-toggle="collapse"
                          data-bs-target="#accordionCustomThree"
                          aria-expanded="false"
                          aria-controls="accordionCustomThree">
                          Accordion Item 3
                        </button>
                      </h2>
                      <div
                        id="accordionCustomThree"
                        class="accordion-collapse collapse"
                  ...
                  <div id="accordionCustomIcon" class="accordion mt-3 accordion-custom-button">
                    ...
                    <div class="accordion-item active">
                      <h2
                        ...
                        id="accordionCustomIconThree">
                        <button
                          type="button"
                          class="accordion-button"
                          data-bs-toggle="collapse"
                          data-bs-target="#accordionCustomIcon-3"
                          aria-expanded="true"
                          aria-controls="accordionCustomIcon-3">
                          <i class="icon-base ti tabler-gift me-2"></i>
                          Accordion Item 3
                        </button>
                      </h2>
                      <div
                        id="accordionCustomIcon-3"
                        class="accordion-collapse collapse show"
                        data-bs-parent="#accordionCustomIcon">
                        <div class="accordion-body">
                          Oat cake toffee chocolate bar jujubes. Marshmallow brownie lemon drops cheesecake. Bonbon
