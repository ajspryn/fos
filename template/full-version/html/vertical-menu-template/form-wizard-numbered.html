...
<html
  ...
  <head>
    ...
    <title>Demo: Wizard Numbered - Forms | Vuexy - Bootstrap Dashboard PRO</title>
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6 form-control-validation form-password-toggle">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <span class="input-group-text cursor-pointer" id="formValidationPass2"
                                  ><i class="icon-base ti tabler-eye-off"></i
                                ></span>
                              </div>
                            </div>
                            <div class="col-sm-6 form-control-validation form-password-toggle">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <span class="input-group-text cursor-pointer" id="formValidationConfirmPass2"
                                  ><i class="icon-base ti tabler-eye-off"></i
                                ></span>
                              </div>
                            </div>
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <select
                                class="selectpicker w-auto"
                                id="formValidationLanguage"
                                data-style="btn-transparent"
                                data-icon-base="icon-base ti"
                                data-tick-icon="tabler-check text-white"
                                name="formValidationLanguage"
                                multiple>
                                <option>English</option>
                                <option>French</option>
                                <option>Spanish</option>
                        ...
                        <div id="social-links-validation" class="content">
                          ...
                          <div class="row g-6">
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input
                                type="text"
                                name="formValidationTwitter"
                                id="formValidationTwitter"
                                class="form-control"
                                placeholder="https://twitter.com/abc" />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input
                                type="text"
                                name="formValidationFacebook"
                                id="formValidationFacebook"
                                class="form-control"
                                placeholder="https://facebook.com/abc" />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input
                                type="text"
                                name="formValidationGoogle"
                                id="formValidationGoogle"
                                class="form-control"
                                placeholder="https://plus.google.com/abc" />
                            </div>
                            <div class="col-sm-6 form-control-validation">
                              ...
                              <input
                                type="text"
                                name="formValidationLinkedIn"
                                id="formValidationLinkedIn"
                                class="form-control"
                                placeholder="https://linkedin.com/abc" />
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                        ...
                        <div id="personal-info-1" class="content">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6">
                              ...
                              <select class="form-select select2" id="country-vertical">
                                <option label=" "></option>
                                <option>UK</option>
                                <option>USA</option>
                                <option>Spain</option>
                        ...
                        <div id="personal-info-modern" class="content">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6">
                              ...
                              <select class="form-select select2" id="country-modern">
                                <option label=" "></option>
                                <option>UK</option>
                                <option>USA</option>
                                <option>Spain</option>
                        ...
                        <div id="personal-info-modern-vertical" class="content">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-sm-6">
                              ...
                              <select class="form-select select2" id="country-modern-vertical">
                                <option label=" "></option>
                                <option>UK</option>
                                <option>USA</option>
                                <option>Spain</option>
