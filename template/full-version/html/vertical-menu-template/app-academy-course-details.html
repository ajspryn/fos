...
<html
  ...
  <head>
    ...
    <title>Demo: Academy - My Courses - App | Vuexy - Bootstrap Dashboard PRO</title>
                          ...
                          <div class="d-flex flex-wrap row-gap-2">
                            <div class="me-12">
                              <p class="text-nowrap mb-2">
                                <i class="icon-base ti tabler-check me-2 align-bottom"></i>Skill level: All Levels
                              </p>
                              <p class="text-nowrap mb-2">
                                <i class="icon-base ti tabler-users me-2 align-top"></i>Students: 38,815
                              </p>
                              <p class="text-nowrap mb-2">
                                <i class="icon-base ti tabler-world me-2 align-bottom"></i>Languages: English
                              </p>
                              <p class="text-nowrap mb-0">
                                <i class="icon-base ti tabler-file me-2 align-bottom"></i>Captions: Yes
                              </p>
                            </div>
                            <div>
                              <p class="text-nowrap mb-2">
                                <i class="icon-base ti tabler-video me-2 align-top ms-50"></i>Lectures: 19
                              </p>
                              <p class="text-nowrap mb-0">
                                <i class="icon-base ti tabler-clock me-2 align-top"></i>Video: 1.5 total hours
                              </p>
                            </div>
                          </div>
                          <hr class="my-6" />
