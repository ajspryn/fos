...
<html
  ...
  <head>
    ...
    <title>Demo: Verify Email Cover - Pages | Vuexy - Bootstrap Dashboard PRO</title>
        ...
        <div class="d-flex col-12 col-xl-4 align-items-center authentication-bg p-6 p-sm-12">
          <div class="w-px-400 mx-auto mt-12 mt-5">
            ...
            <p class="text-start mb-0">
              ...
              <span class="fw-medium">hello@example.com</span> Please follow the link inside to continue.
            </p>
