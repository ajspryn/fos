...
<html
  ...
  <head>
    ...
    <title>Demo: Cards Actions- UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                  ...
                  <div class="card card-action mb-6">
                    ...
                    <div class="collapse show">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          Click on <i class="icon-base ti tabler-chevron-up"></i> to see card collapse in action.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-6">
                    ...
                    <div class="card-header">
                      ...
                      <div class="card-action-element">
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item">
                            <a href="javascript:void(0);" class="card-reload"
                              ><i class="icon-base ti tabler-rotate-clockwise-2 scaleX-n1-rtl"></i
                            ></a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Click on <i class="icon-base ti tabler-rotate-clockwise-2 scaleX-n1-rtl"></i> icon to see
                        refresh card content in action.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card card-action mb-6">
                    ...
                    <div class="card-body">
                      <p class="card-text">
                        ...
                        item. Use <kbd>ESC</kbd> key to exit from the arrows-maximize mode.
                      </p>
                      <p class="card-text">
                        Click on <i class="icon-base ti tabler-arrows-maximize"></i> icon to see expand card in action.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-md">
                  <div class="card card-action mb-6">
                    ...
                    <div class="card-body">
                      ...
                      <br />
                      <p class="card-text">
                        Click on <i class="icon-base ti tabler-x"></i> icon to see remove card in action.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-header header-elements">
                      ...
                      <div class="card-header-elements ms-auto">
                        <button type="button" class="btn btn-xs btn-primary">
                          <span class="icon-base ti tabler-plus icon-xs me-1"></span>Button
                        </button>
                      </div>
                    </div>
                    <div class="card-body">
