...
<html
  ...
  <head>
    ...
    <title>Demo: Badges - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                  ...
                  <div class="card">
                    ...
                    <div class="row row-bordered g-0">
                      <div class="col-md-6 col-xxl-3 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <p>
                            <span class="badge badge-center rounded-pill text-bg-primary"
                              ><i class="icon-base ti tabler-star"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-secondary"
                              ><i class="icon-base ti tabler-sun"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-success"
                              ><i class="icon-base ti tabler-check"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-danger"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-warning"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-info"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center rounded-pill text-bg-dark"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                          <p>
                            <span class="badge badge-center text-bg-primary"
                              ><i class="icon-base ti tabler-star"></i
                            ></span>
                            <span class="badge badge-center text-bg-secondary"
                              ><i class="icon-base ti tabler-sun"></i
                            ></span>
                            <span class="badge badge-center text-bg-success"
                              ><i class="icon-base ti tabler-check"></i
                            ></span>
                            <span class="badge badge-center text-bg-danger"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center text-bg-warning"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center text-bg-info"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center text-bg-dark"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                        </div>
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <p>
                            ...
                            <span class="badge badge-center bg-label-danger"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center bg-label-warning"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center bg-label-info"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center bg-label-dark"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                        </div>
                      ...
                      <div class="col-md-6 col-xxl-3 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <p>
                            <span class="badge badge-center rounded-pill badge-outline-primary"
                              ><i class="icon-base ti tabler-star"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-secondary"
                              ><i class="icon-base ti tabler-sun"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-success"
                              ><i class="icon-base ti tabler-check"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-danger"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-warning"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-info"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center rounded-pill badge-outline-dark"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                          <p>
                            <span class="badge badge-center badge-outline-primary"
                              ><i class="icon-base ti tabler-star"></i
                            ></span>
                            <span class="badge badge-center badge-outline-secondary"
                              ><i class="icon-base ti tabler-sun"></i
                            ></span>
                            <span class="badge badge-center badge-outline-success"
                              ><i class="icon-base ti tabler-check"></i
                            ></span>
                            <span class="badge badge-center badge-outline-danger"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center badge-outline-warning"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center badge-outline-info"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center badge-outline-dark"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                        </div>
                      ...
                      <div class="col-md-6 col-xxl-3 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <p>
                            <span class="badge badge-center bg-primary bg-glow"
                              ><i class="icon-base ti tabler-star"></i
                            ></span>
                            <span class="badge badge-center bg-secondary bg-glow"
                              ><i class="icon-base ti tabler-sun"></i
                            ></span>
                            <span class="badge badge-center bg-success bg-glow"
                              ><i class="icon-base ti tabler-check"></i
                            ></span>
                            <span class="badge badge-center bg-danger bg-glow"
                              ><i class="icon-base ti tabler-clock"></i
                            ></span>
                            <span class="badge badge-center bg-warning bg-glow"
                              ><i class="icon-base ti tabler-cloud"></i
                            ></span>
                            <span class="badge badge-center bg-info bg-glow"
                              ><i class="icon-base ti tabler-folder"></i
                            ></span>
                            <span class="badge badge-center bg-dark bg-glow"
                              ><i class="icon-base ti tabler-headphones"></i
                            ></span>
                          </p>
                        </div>
                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="card-body d-flex flex-wrap gap-4">
                      <button
                        type="button"
                        class="btn btn-label-primary text-nowrap d-inline-flex position-relative me-4">
                        Badge
                        <span
                      ...
                      <button
                        type="button"
                        class="btn btn-label-warning text-nowrap d-inline-flex position-relative me-4">
                        Label Badge
                        <span
                          class="position-absolute top-0 start-100 translate-middle badge badge-center rounded-pill bg-warning text-white"
                          >12</span
                        >
                      </button>
