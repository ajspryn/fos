...
<html
  ...
  <head>
    ...
    <title>Demo: Cards basic - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
              ...
              <div class="row mb-12 g-6">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card">
                    ...
                    <img class="card-img-bottom" src="../../assets/img/elements/1.png" alt="Card image cap" />
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card text-bg-dark border-0">
                    <img class="card-img" src="../../assets/img/elements/12.png" alt="Card image" />
              ...
              <div class="row mb-12 g-6">
                <div class="col-md">
                  <div class="card">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img class="card-img card-img-left" src="../../assets/img/elements/12.png" alt="Card image" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                ...
                <div class="col-md">
                  <div class="card">
                    <div class="row g-0">
                      ...
                      <div class="col-md-4">
                        <img class="card-img card-img-right" src="../../assets/img/elements/17.png" alt="Card image" />
                      </div>
                    </div>
                  </div>
                </div>
