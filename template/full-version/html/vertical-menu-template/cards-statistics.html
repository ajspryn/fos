...
<html
  ...
  <head>
    ...
    <title>Demo: Cards Statistics- UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                  ...
                  <div class="card h-100">
                    <div class="card-body text-center">
                      <div class="badge rounded p-2 bg-label-success mb-2">
                        <i class="icon-base ti tabler-message-dots icon-lg"></i>
                      </div>
                        ...
                        <div class="col-4">
                          <div class="d-flex gap-2 align-items-center mb-2">
                            <span class="badge bg-label-info rounded"
                              ><i class="icon-base ti tabler-shopping-cart icon-18px"></i
                            ></span>
                        ...
                        <div class="col-4 text-end">
                          <div class="d-flex gap-2 justify-content-end align-items-center mb-2">
                            ...
                            <span class="badge bg-label-primary rounded"
                              ><i class="icon-base ti tabler-link icon-18px"></i
                            ></span>
                          </div>
