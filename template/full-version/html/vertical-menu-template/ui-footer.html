...
<html
  ...
  <head>
    ...
    <title>Demo: Footer - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
              ...
              <section id="basic-footer">
                ...
                <footer class="footer bg-light">
                  <div
                    ...
                    <div>
                      <a
                        href="https://demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/"
                        target="_blank"
                    ...
                    <div class="d-flex flex-column flex-sm-row">
                      <a href="https://themeforest.net/licenses/standard" class="footer-link me-6" target="_blank"
                        >License</a
                      >
                      ...
                      <div class="dropdown dropup footer-link">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="icon-base ti tabler-currency-dollar"></i> USD</a
                          >
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="icon-base ti tabler-currency-euro"></i> Euro</a
                          >
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="icon-base ti tabler-currency-pound"></i> Pound</a
                          >
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="javascript:void(0);"
                            ><i class="icon-base ti tabler-currency-bitcoin"></i> Bitcoin</a
                          >
                        </div>
                      </div>
                      <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"
                        ><i class="icon-base ti tabler-logout icon-xs me-1"></i>Logout</a
                      >
                    </div>
                  </div>
                </footer>
                  ...
                  <div
                    ...
                    <div>
                      <a
                        ...
                        target="_blank"
                        class="footer-text fw-medium"
                        ><span class="text-body">Vuexy</span></a
                      >
                      ©
                    </div>
                    <div class="d-flex flex-column flex-sm-row">
                      ...
                      <div class="col-12 col-sm-6 col-md-3 mb-6 mb-sm-0">
                        ...
                        <div class="social-icon my-4">
                          <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-facebook me-2"
                            ><i class="icon-base ti tabler-brand-facebook icon-20px"></i
                          ></a>
                          <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-twitter me-2"
                            ><i class="icon-base ti tabler-brand-twitter icon-20px"></i
                          ></a>
                          <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-linkedin me-2"
                            ><i class="icon-base ti tabler-brand-linkedin icon-20px"></i
                          ></a>
                          <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-github"
                            ><i class="icon-base ti tabler-brand-github icon-20px"></i
                          ></a>
                        </div>
                        <p class="pt-6">
                          <script>
