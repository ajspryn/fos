...
<html
  ...
  <head>
    ...
    <title>Demo: Buttons - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                      ...
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-primary">
                            <span class="icon-xs icon-base ti tabler-star me-2"></span>Primary
                          </button>
                          <button type="button" class="btn btn-secondary">
                            <span class="icon-xs icon-base ti tabler-bell me-2"></span>Secondary
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                      ...
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-facebook">
                            <i class="icon-base ti tabler-brand-facebook icon-xs me-1"></i> Facebook
                          </button>
                          <button type="button" class="btn btn-twitter">
                            <i class="icon-base ti tabler-brand-twitter icon-xs me-1"></i> Twitter
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-google-plus">
                            <i class="icon-base ti tabler-brand-google icon-xs me-2"></i> Google+
                          </button>
                          <button type="button" class="btn rounded-pill btn-instagram">
                            <i class="icon-base ti tabler-brand-instagram icon-xs me-2"></i> Instagram
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-label-linkedin">
                            <i class="icon-base ti tabler-brand-linkedin icon-xs me-2"></i> Linkedin
                          </button>
                          <button type="button" class="btn btn-label-github">
                            <i class="icon-base ti tabler-brand-github icon-xs me-2"></i> Github
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-label-pinterest">
                            <i class="icon-base ti tabler-brand-pinterest icon-xs me-2"></i> Pinterest
                          </button>
                          <button type="button" class="btn rounded-pill btn-label-slack">
                            <i class="icon-base ti tabler-brand-slack icon-xs me-2"></i> Slack
                          </button>
                        </div>
                      </div>
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn btn-outline-dribbble">
                            <i class="icon-base ti tabler-brand-dribbble icon-xs me-2"></i> Dribbble
                          </button>
                          <button type="button" class="btn btn-text-reddit">
                            <i class="icon-base ti tabler-brand-reddit icon-xs me-2"></i> Reddit
                          </button>
                        </div>
                        <div class="demo-inline-spacing">
                          <button type="button" class="btn rounded-pill btn-outline-youtube">
                            <i class="icon-base ti tabler-brand-youtube icon-xs me-2"></i> Youtube
                          </button>
                          <button type="button" class="btn rounded-pill btn-text-vimeo">
                            <i class="icon-base ti tabler-brand-vimeo icon-xs me-2"></i> Vimeo
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <button type="button" class="btn btn-icon btn-label-github">
                            <i class="icon-base ti tabler-brand-github icon-22px"></i>
                          </button>
                      ...
                      <div class="col-lg-4 p-6">
                        ...
                        <div class="demo-inline-spacing">
                          ...
                          <button type="button" class="btn btn-icon btn-text-reddit">
                            <i class="icon-base ti tabler-brand-reddit icon-22px"></i>
                          </button>
                        ...
                        <div class="col-xl-6 mb-xl-0 mb-4">
                          ...
                          <div
                            ...
                            <div class="btn-group" role="group" aria-label="First group">
                              ...
                              <button type="button" class="btn btn-outline-secondary">
                                <i class="icon-base ti tabler-browser-check"></i>
                              </button>
                            </div>
                            <div class="btn-group" role="group" aria-label="Second group">
                              <button type="button" class="btn btn-outline-secondary">
                                <i class="icon-base ti tabler-bold"></i>
                              </button>
                              <button type="button" class="btn btn-outline-secondary">
                                <i class="icon-base ti tabler-italic"></i>
                              </button>
                              <button type="button" class="btn btn-outline-secondary">
                                <i class="icon-base ti tabler-underline"></i>
                              </button>
                            </div>
                            <div class="btn-group" role="group" aria-label="Third group">
                              <button type="button" class="btn btn-outline-secondary">
                                <i class="icon-base ti tabler-volume-2"></i>
                              </button>
                            </div>
                          </div>
                        </div>
