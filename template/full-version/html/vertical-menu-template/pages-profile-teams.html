...
<html
  ...
  <head>
    ...
    <title>Demo: User Profile - Teams | Vuexy - Bootstrap Dashboard PRO</title>
                        ...
                        <div class="ms-auto">
                          <ul class="list-inline mb-0 d-flex align-items-center">
                            <li class="list-inline-item me-0">
                              <a
                                href="javascript:void(0);"
                                class="d-flex align-self-center btn btn-icon btn-text-secondary rounded-pill"
                                ><i class="icon-base ti tabler-star icon-22px text-body-secondary"></i
                              ></a>
                            </li>
                            <li class="list-inline-item">
                              <div class="dropdown">
