...
<html
  ...
  <head>
    ...
    <title>Demo: eCommerce Referral - App | Vuexy - Bootstrap Dashboard PRO</title>
                          ...
                          <div class="d-flex gap-4 align-items-end">
                            ...
                            <div>
                              <button type="submit" class="btn btn-primary">
                                <i class="icon-base ti tabler-check icon-xs me-2"></i>Submit
                              </button>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="d-flex gap-4 align-items-end">
                            ...
                            <div class="d-flex">
                              <button type="button" class="btn btn-facebook btn-icon me-2">
                                <i class="icon-base ti tabler-brand-facebook text-white icon-22px"></i>
                              </button>
                              <button type="button" class="btn btn-twitter btn-icon">
                                <i class="icon-base ti tabler-brand-twitter text-white icon-22px"></i>
                              </button>
                            </div>
                          </div>
                        </div>
