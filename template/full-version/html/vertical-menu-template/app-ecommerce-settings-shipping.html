...
<html
  ...
  <head>
    ...
    <title>Demo: Settings Shipping &amp; Delivery - eCommerce | Vuexy - Bootstrap Dashboard PRO</title>
                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div>
                              <a
                                href="javascript:void(0);"
                                class="btn btn-sm btn-icon btn-text-secondary text-secondary rounded-pill me-1"
                                ><i class="icon-base ti tabler-pencil icon-20px"></i
                              ></a>
                              <a
                                href="javascript:void(0);"
                                class="btn btn-sm btn-icon btn-text-secondary text-secondary rounded-pill"
                                      ...
                                      <div class="dropdown pe-4">
                                        ...
                                        <div class="dropdown-menu">
                                          <a class="dropdown-item" href="javascript:void(0);"
                                            ><i class="icon-base ti tabler-edit me-1"></i> Edit</a
                                          >
                                          <a class="dropdown-item" href="javascript:void(0);"
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-end">
                                      <div class="dropdown pe-4">
                                        ...
                                        <div class="dropdown-menu">
                                          <a class="dropdown-item" href="javascript:void(0);"
                                            ><i class="icon-base ti tabler-edit me-2"></i> Edit</a
                                          >
                                          <a class="dropdown-item" href="javascript:void(0);"
                                            ><i class="icon-base ti tabler-trash me-2"></i> Delete</a
                                          >
                                        </div>
                                      </div>
                                    </td>
