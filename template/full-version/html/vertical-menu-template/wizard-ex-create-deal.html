...
<html
  ...
  <head>
    ...
    <title>Demo: Create Deal - Wizard Examples | Vuexy - Bootstrap Dashboard PRO</title>
                      ...
                      <div class="row g-6">
                        ...
                        <div class="col-lg-12">
                          <div class="form-check form-switch my-2 ms-2">
                            ...
                            <label for="dealLimitUser" class="switch-label"
                              >Limit this discount to a single-use per customer?</label
                            >
                          </div>
                        </div>
                        <div class="col-12 d-flex justify-content-between">
