...
<html
  ...
  <head>
    ...
    <title>Demo: Sticky Actions - Forms | Vuexy - Bootstrap Dashboard PRO</title>
                        ...
                        <div class="col-lg-8 mx-auto">
                          ...
                          <div class="row g-6">
                            ...
                            <div class="col-12">
                              <ul class="list-group">
                                <li
                                  class="list-group-item d-flex align-items-center justify-content-between flex-column flex-sm-row">
                                  <div class="offer">
                                    <p class="mb-0 fw-medium">TAKEITALL</p>
                                    <span>Apply this code to get 15% discount on orders above 20$.</span>
                                  </div>
                                  <div class="apply mt-6 mt-sm-0">
                            ...
                            <div>
                              <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label d-flex gap-1" for="collapsible-payment-cc">
                                  Credit/Debit/ATM Card <i class="icon-base ti tabler-credit-card"></i>
                                </label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input
                                ...
                                <label class="form-check-label d-flex gap-1" for="collapsible-payment-cash">
                                  Cash On Delivery
                                  <i
                                    class="icon-base ti tabler-help"
                                    data-bs-toggle="tooltip"
                                    data-bs-placement="top"
                                    ...
                                    <div class="mb-6">
                                      ...
                                      <div class="input-group input-group-merge">
                                        ...
                                        <span class="input-group-text cursor-pointer" id="collapsible-payment-cvv2"
                                          ><i
                                            class="icon-base ti tabler-help icon-xs"
                                            data-bs-toggle="tooltip"
                                            data-bs-placement="top"
