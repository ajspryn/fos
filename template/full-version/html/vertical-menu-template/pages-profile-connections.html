...
<html
  ...
  <head>
    ...
    <title>Demo: User Profile - Connections | Vuexy - Bootstrap Dashboard PRO</title>
                    ...
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      <li class="nav-item">
                        <a class="nav-link" href="pages-profile-user.html"
                          ><i class="icon-base ti tabler-user icon-sm me-1_5"></i> Profile</a
                        >
                      </li>
                      <li class="nav-item">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="d-flex align-items-center justify-content-center">
                        <a href="javascript:;" class="btn btn-label-primary d-flex align-items-center me-4"
                          ><i class="icon-base ti tabler-user-plus icon-xs me-2"></i>Connect</a
                        >
                        <a href="javascript:;" class="btn btn-label-secondary btn-icon"
                          ><i class="icon-base ti tabler-mail icon-22px"></i
                        ></a>
