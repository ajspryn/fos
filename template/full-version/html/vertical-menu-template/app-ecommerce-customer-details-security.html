...
<html
  ...
  <head>
    ...
    <title>Demo: eCommerce Customer Details Security - Pages | Vuexy - Bootstrap Dashboard PRO</title>
                          ...
                          <div class="col-12 col-sm-6 form-password-toggle form-control-validation">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <span class="input-group-text cursor-pointer"
                                ><i class="icon-base ti tabler-eye icon-xs"></i
                              ></span>
                            </div>
                          </div>
                      ...
                      <div class="mb-4">
                        <div class="d-flex w-100 action-icons">
                          ...
                          <a href="javascript:;" class="btn btn-icon btn-text-secondary rounded-pill"
                            ><i class="icon-base ti tabler-user-plus icon-md text-heading"></i
                          ></a>
                        </div>
                      </div>
                      <p class="mb-0">
