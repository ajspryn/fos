...
<html
  ...
  <head>
    ...
    <title>Demo: Account settings - Pages | Vuexy - Bootstrap Dashboard PRO</title>
                      ...
                      <div class="col-md-6 col-12">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            ...
                            <div class="flex-grow-1 row">
                              ...
                              <div class="col-5 text-end mt-sm-0 mt-2">
                                <button class="btn btn-icon btn-label-secondary">
                                  <i class="icon-base icon-22px ti tabler-link"></i>
                                </button>
                              </div>
                            </div>
                          </div>
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="../../assets/img/icons/brands/twitter-light.png"
                                alt="twitter"
                                class="me-4"
                                height="32"
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-7">
                                ...
                                <a href="https://x.com/pixinvents" target="_blank" class="small">@Pixinvent</a>
                              </div>
                              <div class="col-5 text-end mt-sm-0 mt-2">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-7">
                                ...
                                <a href="https://www.instagram.com/pixinvents/" target="_blank" class="small"
                                  >@Pixinvent</a
                                >
                              </div>
                              <div class="col-5 text-end mt-sm-0 mt-2">
