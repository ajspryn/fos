...
<html
  ...
  <head>
    ...
    <title>Demo: Settings Store Details - eCommerce | Vuexy - Bootstrap Dashboard PRO</title>
                      ...
                      <div class="card mb-6">
                        ...
                        <div class="card-body">
                          <div class="row mb-6 g-6">
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-1" for="ecommerce-settings-details-phone">Phone</label>
                              <input
                                type="tel"
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-1" for="ecommerce-settings-details-email"
                          ...
                          <div class="alert row alert-warning mb-0 h5 mx-0 " role="alert">
                            ...
                            <div class="col text-wrap ps-4 pe-0 pt-sm-1">
                      ...
                      <div class="card mb-6">
                        ...
                        <div class="card-body">
                          <div class="row g-6">
                            ...
                            <div class="col-12 col-md-6">
                              <label class="form-label mb-1" for="ecommerce-settings-sender-suffix">Suffix</label>
                              <input
                                type="text"
                                class="form-control"
