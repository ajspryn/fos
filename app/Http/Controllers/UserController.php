...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $dataNasabahP3k = P3kNasabah::join('p3k_pekerjaans', 'p3k_nasabahs.id', '=', 'p3k_pekerjaans.p3k_nasabah_id')->select(DB::raw('count(nama_unit_kerja) as unit_kerja, nama_unit_kerja,count(p3k_nasabahs.id) as noa'))->groupBy('nama_unit_kerja')->orderBy('noa', 'desc')->get();
        ...
        return view('profile', [
            ...
            'dataNasabahP3ks' => $dataNasabahP3k,
        ]);
    }
