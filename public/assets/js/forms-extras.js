...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  const inputMaxLength = inputElement
    ? inputElement.getAttribute("maxlength")
    : null;

  // Set initial character count (guard elements exist)
  if (inputElement && inputInfo && inputMaxLength) {
  ...
  const textareaMaxLength = textareaElement
    ? textareaElement.getAttribute("maxlength")
    : null;

  if (textareaElement && textareaInfo && textareaMaxLength) {
    window.Helpers.maxLengthCount(
      textareaElement,
      textareaInfo,
      textareaMaxLength,
    );
